...
| [goharbor/harbor](https://github.com/goharbor/harbor) | Apache-2.0|21932|2016-01-28|2024-03-15 | 最为知名，且大概是在企业内部使用最多的 Docker 镜像仓库 |
...
| [goodrain/rainbond](https://github.com/goodrain/rainbond) | LGPL-3.0|4668|2017-11-05|2024-03-15 | k8s 集群管理应用平台 |
| [rancher/rancher](https://github.com/rancher/rancher) | Apache-2.0|22384|2014-11-07|2024-03-15 | 一个开源容器管理平台，专为在生产中部署容器的组织而构建。Rancher 让您可以轻松地在任何地方运行 Kubernetes、满足 IT 要求并为 DevOps 团队提供支持 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [alibaba/Sentinel](https://github.com/alibaba/Sentinel) | Apache-2.0|21846|2018-04-04|2024-03-05 | 面向云原生微服务的高可用流控防护组件 |
...
| [k8gb-io/k8gb](https://github.com/k8gb-io/k8gb) | Apache-2.0|717|2019-11-27|2024-03-14 | Kubernetes 的完全开源、云原生、全局负载均衡解决方案 |
| [eldadru/ksniff](https://github.com/eldadru/ksniff) | Apache-2.0|3006|2018-06-17|2023-11-19 | kubectl 插件，利用 tcpdump 和 Wireshark 在 K8s 集群中的 pod 上启动远程捕获 |
...
| [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) | Apache-2.0|10413|2021-04-19|2024-03-14 | K8s 的 API 流量分析器，提供对 K8s 内部网络的实时协议级可见性，捕获和监控进出以及跨容器、pod、节点和集群的所有流量和负载 |
| [traefik/traefik](https://github.com/traefik/traefik) | MIT|47207|2015-09-13|2024-03-15 | 一种现代 HTTP 反向代理和负载均衡器，可以轻松部署微服务 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [stakater/Reloader](https://github.com/stakater/Reloader) | Apache-2.0|6531|2018-07-04|2024-03-12 | 一款 Kubernetes 控制器，用于监视 ConfigMap 和 Secrets 的更改，并对其关联的 Deployment、StatefulSet、DaemonSet 和 DeploymentConfig 中的 Pods 进行滚动升级 |
| [wise2c-devops/breeze](https://github.com/wise2c-devops/breeze) | Apache-2.0|1001|2018-08-27|2024-02-27 |  可用于生产环境的图形化 Kubernetes 集群部署工具  |
| [cert-manager/cert-manager](https://github.com/cert-manager/cert-manager) | Apache-2.0|11322|2017-05-24|2024-03-15 | 在 Kubernetes 中自动配置和管理 TLS 证书 |
| [gocrane/crane](https://github.com/gocrane/crane) | Apache-2.0|1743|2021-11-18|2024-03-15 | Crane 是一个基于 FinOps 的云资源分析与成本优化平台。它的愿景是在保证客户应用运行质量的前提下实现极致的降本。 |
| [komodorio/helm-dashboard](https://github.com/komodorio/helm-dashboard) | Apache-2.0|4645|2022-08-22|2024-03-14 | Helm 缺失的用户界面 - 可视化你的发布 |
| [airwallex/k8s-pod-restart-info-collector](https://github.com/airwallex/k8s-pod-restart-info-collector) | N/A|302|2022-08-29|2023-12-29 | 监视 Pod 更改并在 Pod 重新启动时将 K8s Pod 重新启动原因、日志和事件收集到 Slack 通道 |
| [Soluto/kamus](https://github.com/Soluto/kamus) | Apache-2.0|908|2018-06-14|2023-09-28 | 一种适用于 Kubernetes 应用的开源、基于 Git-ops、零信任的秘密加密和解密方案 |
| [kedacore/keda](https://github.com/kedacore/keda) | Apache-2.0|7603|2019-02-13|2024-03-15 | KEDA 是一个基于 Kubernetes 的事件驱动自动伸缩组件。它为在 Kubernetes 中运行的任何容器提供基于事件的伸缩能力。 |
| [kubewharf/kelemetry](https://github.com/kubewharf/kelemetry) | Apache-2.0|219|2023-03-14|2024-03-13 | 将 Kubernetes 事件、审计日志、通知者等各种数据源聚合成传统追踪的形式，通过 Jaeger UI 实现可视化和自动分析。 |
...
| [1Panel-dev/webkubectl](https://github.com/1Panel-dev/webkubectl) | Apache-2.0|820|2019-10-14|2024-02-21 |  Web Kubectl 帮助您管理 kubernetes 集群的凭据，并在 Web 浏览器中运行 kubectl 命令，从而不必在本地 PC 或其他服务器上安装 kubectl，并且 Web Kubectl 也适用于团队多人同时使用，此外还可以使用 API 集成到您自己的应用中。 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [smartloli/EFAK](https://github.com/smartloli/EFAK) | Apache-2.0|2984|2017-02-04|2023-08-30 | 一个开源的 Kafka 集群管理和监控工具，旨在帮助用户更好地管理和监控其 Kafka 集群。 |
| [didi/KnowStreaming](https://github.com/didi/KnowStreaming) | AGPL-3.0|6684|2020-03-19|2024-01-06 | 一站式云原生实时流数据平台，通过0侵入、插件化构建企业级 Kafka 服务，极大降低操作、存储和管理实时流数据门槛 |
| [obsidiandynamics/kafdrop](https://github.com/obsidiandynamics/kafdrop) | Apache-2.0|5102|2019-05-27|2024-03-14 | 一个用于查看 Kafka 主题和浏览消费者组的 Web UI。该工具显示代理、主题、分区、消费者等信息，并允许您查看消息 |
| [xxd763795151/kafka-console-ui](https://github.com/xxd763795151/kafka-console-ui) | MIT|462|2021-08-30|2024-03-03 |  一款轻量级的 kafka 可视化管理平台，安装配置快捷、简单易用。 |
...
| [provectus/kafka-ui](https://github.com/provectus/kafka-ui) | Apache-2.0|8202|2019-11-26|2024-03-13 | 一款 Python&#43;Vue 写的 Kafka-Web 管理后台 |
...
| [feiyu563/PrometheusAlert](https://github.com/feiyu563/PrometheusAlert) | MIT|2565|2018-11-15|2024-02-04 |  开源的运维告警中心消息转发系统，支持主流的监控系统 Prometheus, Zabbix,  日志系统 Graylog 和数据可视化系统 Grafana 发出的预警消息，支持钉钉，微信，华为云短信，腾讯云短信，腾讯云电话，阿里云短信，阿里云电话等  |
| [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | Apache-2.0|10568|2018-09-30|2024-03-15 | 快速，经济高效的监控解决方案和时序数据库，可用于 Prometheus 或 Grafana 的存储 |
...
| [dianping/cat](https://github.com/dianping/cat) | Apache-2.0|18360|2012-12-05|2024-01-29 | CAT 作为服务端项目基础组件，提供了 Java, C/C&#43;&#43;, Node.js, Python, Go 等多语言客户端 |
| [clklog/clklog](https://github.com/clklog/clklog) | AGPL-3.0|31|2023-09-13|2024-03-15 | 一款记录用户行为分析和画像的免费可商用开源软件，技术人员可快速搭建私有的应用系统。 |
| [dataease/dataease](https://github.com/dataease/dataease) | GPL-3.0|14742|2021-02-02|2024-03-15 | DataEase 是开源的数据可视化分析工具，帮助用户快速分析数据并洞察业务趋势，从而实现业务的改进与优化。DataEase 支持丰富的数据源连接，能够通过拖拉拽方式快速制作图表，并可以方便的与他人分享。 |
| [deepflowio/deepflow](https://github.com/deepflowio/deepflow) | Apache-2.0|2202|2022-01-16|2024-03-15 | DeepFlow 开源项目旨在为复杂的云基础设施及云原生应用提供深度可观测性。 |
| [AutohomeCorp/frostmourne](https://github.com/AutohomeCorp/frostmourne) | MIT|1286|2019-12-16|2023-06-14 | 基于 Elasticsearch,  Prometheus,  SkyWalking,  InfluxDB，MySQL/TiDB，ClickHouse,  SQLServer,  IoTDB 数据的分布式监控报警系统 |
| [grafana/grafana](https://github.com/grafana/grafana) | AGPL-3.0|59748|2013-12-11|2024-03-15 | 开放且可组合的可观测性和数据可视化平台。可视化来自 Prometheus、Loki、Elasticsearch、InfluxDB、Postgres 等多个来源的指标、日志和跟踪。 |
| [dromara/hertzbeat](https://github.com/dromara/hertzbeat) | Apache-2.0|4360|2022-02-04|2024-03-15 | 易用友好的开源实时监控告警系统，无需 Agent，高性能集群，兼容 Prometheus，强大自定义监控能力 |
| [cilium/hubble](https://github.com/cilium/hubble) | Apache-2.0|3210|2019-11-19|2024-03-15 | Hubble - 使用 eBPF 的 Kubernetes 网络、服务和安全可观测性 |
...
| [nvm-sh/nvm](https://github.com/nvm-sh/nvm) | MIT|74624|2010-04-15|2024-03-09 | 一个简单的工具，用于多个 Node 版本的管理与切换 |
| [sdkman/sdkman-cli](https://github.com/sdkman/sdkman-cli) | Apache-2.0|5782|2012-08-27|2024-02-17 | 在任何基于 Unix 的系统上管理多个软件开发工具包的多个版本的工具 |
| [stefanmaric/g](https://github.com/stefanmaric/g) | MIT|871|2018-04-08|2023-07-10 | 又又一个用于多个 Golang 版本的管理与切换，包基于二进制安装 |
| [version-fox/vfox](https://github.com/version-fox/vfox) | Apache-2.0|1441|2023-12-09|2024-03-15 | 跨平台的用于管理 SDK 版本的工具，允许你通过命令行快速安装和切换不同版本的 SDK |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [BookStackApp/BookStack](https://github.com/BookStackApp/BookStack) | MIT|13552|2015-08-29|2024-03-15 | 使用 PHP 和 Laravel 构建的创建文档/wiki 内容的平台 |
| [zmister2016/MrDoc](https://github.com/zmister2016/MrDoc) | GPL-3.0|2782|2020-04-10|2024-02-26 | 觅思文档，适合于个人和中小型团队的在线文档、知识库系统 |
| [facebook/docusaurus](https://github.com/facebook/docusaurus) | MIT|52015|2017-06-20|2024-03-15 | 一个用于轻松构建、部署和维护开源项目网站的项目 |
| [halo-dev/halo](https://github.com/halo-dev/halo) | GPL-3.0|30886|2018-03-21|2024-03-15 | 强大易用的开源建站工具，更偏向于博客风格 |
| [usememos/memos](https://github.com/usememos/memos) | MIT|25946|2021-12-08|2024-03-15 | 一项隐私优先的轻量级笔记服务, 轻松捕捉并分享您的精彩想法, [flomo](https://flomoapp.com/) 的开源替代品 |
| [mkdocs/mkdocs](https://github.com/mkdocs/mkdocs) | BSD-2-Clause|18064|2014-01-11|2024-03-08 | MkDocs 是一个快速、简单且华丽的静态站点生成器，适用于构建项目文档。文档源文件是用 Markdown 编写的，并使用单个 YAML 配置文件进行配置。它的设计易于使用，并且可以通过第三方主题、插件和 Markdown 扩展进行扩展。 |
| [fantasticit/think](https://github.com/fantasticit/think) | MIT|1797|2022-02-20|2024-03-14 | 一款开源知识管理工具，通过独立的知识库空间，结构化地组织在线协作文档，实现知识的积累与沉淀，促进知识的复用与流通 |
| [mylxsw/wizard](https://github.com/mylxsw/wizard) | Apache-2.0|2124|2017-07-27|2023-03-22 | 一款开源的文档管理工具，支持 Markdown/Swagger/Table 类型的文档 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [pretty66/iptables-web](https://github.com/pretty66/iptables-web) | Apache-2.0|463|2022-04-03|2023-10-27 | 一个轻量级的 iptables Web 管理界面程序，支持二进制文件直接运行及 Docker 快速部署安装 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [fatedier/frp](https://github.com/fatedier/frp) | Apache-2.0|78207|2015-12-21|2024-03-15 | 一个专注于内网穿透的高性能的反向代理应用，支持 TCP、UDP、HTTP、HTTPS 等多种协议。可以将内网服务以安全、便捷的方式通过具有公网 IP 节点的中转暴露到公网 |
| [go-gost/gost](https://github.com/go-gost/gost) | MIT|3167|2020-02-12|2024-03-13 | GO语言实现的安全隧道 |
| [joggle-cn/joggle](https://github.com/joggle-cn/joggle) | Apache-2.0|114|2017-12-06|2023-12-28 | Joggle 是基于 Ngrok 二开的开源内网穿透项目，支持多节点、私有部署、云服务。 |
| [dromara/neutrino-proxy](https://github.com/dromara/neutrino-proxy) | MIT|407|2022-06-10|2024-03-15 | 一个基于 Netty 的、开源的 Java 内网穿透项目。 |
| [ehang-io/nps](https://github.com/ehang-io/nps) | GPL-3.0|28803|2018-11-04|2024-01-11 | 一款轻量级、高性能、功能强大的内网穿透代理服务器。支持 tcp、udp、socks5、http 等几乎所有流量转发，可用来访问内网网站、本地支付接口调试、ssh 访问、远程桌面，内网 dns 解析、内网 socks5 代理等，并带有功能强大的 web 管理端。 |
...
| [lwch/natpass](https://github.com/lwch/natpass) | MIT|4009|2021-07-30|2024-03-14 | 主机管理工具，支持 Shell 管理，支持远程桌面管理 |
| [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) | Apache-2.0|4180|2020-12-20|2024-03-05 | 一个 Golang 开发的简单好用安全的开源交互审计系统，支持 RDP、SSH、VNC、Telnet、Kubernetes 协议 |
| [yinheli/sshw](https://github.com/yinheli/sshw) | MIT|778|2018-07-21|2023-10-10 | 一款实现了类似 jumpserver 登陆界面的终端 SSH 工具 |
| [trzsz/trzsz-ssh](https://github.com/trzsz/trzsz-ssh) | MIT|1256|2023-05-21|2024-03-03 | 支持 trzsz ( trz / tsz ) 的 ssh 客户端，支持搜索和选择服务器进行批量登录，支持记住密码 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [madneal/gshark](https://github.com/madneal/gshark) | Apache-2.0|799|2018-03-09|2024-03-14 | 根据关键字等规则，从 GitHub、GitLab 等扫描代码泄露、敏感信息泄露等安全问题 |
| [reviewdog/reviewdog](https://github.com/reviewdog/reviewdog) | MIT|7215|2016-10-17|2024-03-13 | reviewdog 提供了一种通过轻松与任何 linter 工具集成来自动将审阅评论发布到代码托管服务（例如 GitHub）的方法。它使用 lint 工具的输出，并将其作为评论发布（如果发现的结果位于要审查的补丁的差异中）。 |
| [SonarSource/sonarqube](https://github.com/SonarSource/sonarqube) | LGPL-3.0|8464|2011-01-05|2024-03-14 | SonarQube 不仅能够显示应用程序的运行状况，还能够突出显示新引入的问题。有了质量门，您就可以实现干净的代码，从而系统地提高代码质量。 |
| [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) | AGPL-3.0|13637|2016-12-31|2024-03-15 | 一款用于扫描代码中是否包含密码，秘钥等敏感信息的工具，可以集成到你的流水线当中 |
| [chaitin/veinmind-tools](https://github.com/chaitin/veinmind-tools) | MIT|1453|2022-02-08|2024-01-10 | 容器安全工具集，支持容器恶意文件，弱口令，漏洞，后门等扫描能力 |
...
| [wansenai/flow](https://github.com/wansenai/flow) | Apache-2.0|682|2021-05-27|2023-12-27 | 开箱即用的流程引擎一体化解决方案 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [ntt360/pmon2](https://github.com/ntt360/pmon2) | Apache-2.0|962|2020-07-20|2023-12-30 | Golang 进程管理工具，类似 Node 进程管理的 PM2 |
| [ochinchina/supervisord](https://github.com/ochinchina/supervisord) | MIT|3824|2016-09-25|2024-03-13 | 基于 Golang 实现的 Supervisord 进程管理工具 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [polarismesh/polaris](https://github.com/polarismesh/polaris) | NOASSERTION|2269|2021-06-14|2024-03-15 | 支持多语言和多框架的服务发现和治理平台，致力于解决分布式和微服务架构中的服务管理、流量管理、故障容错、配置管理和可观测性问题 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [LinShunKang/MyPerf4J](https://github.com/LinShunKang/MyPerf4J) | BSD-3-Clause|3189|2018-03-11|2024-02-16 | 一个针对高并发、低延迟应用设计的高性能 Java 性能监控和统计工具。 |
| [alibaba/arthas](https://github.com/alibaba/arthas) | Apache-2.0|34433|2018-08-29|2024-03-08 | Arthas 是一款线上监控诊断产品，通过全局视角实时查看应用 load、内存、gc、线程的状态信息，并能在不修改应用代码的情况下，对业务问题进行诊断，包括查看方法调用的出入参、异常，监测方法执行耗时，类加载信息等，大大提升线上问题排查效率。 |
...
| [brendangregg/perf-tools](https://github.com/brendangregg/perf-tools) | GPL-2.0|9533|2014-07-10|2023-11-22 | Linux 性能分析工具集合 |
| [grafana/pyroscope](https://github.com/grafana/pyroscope) | AGPL-3.0|9236|2020-12-31|2024-03-15 |  性能分析平台，用于分析 CPU 利用率和内存泄漏等应用性能问题 |
...
| [avwo/whistle](https://github.com/avwo/whistle) | MIT|13604|2015-03-13|2024-03-10 | 基于 Node 实现的跨平台本地抓包调试工具 |
...
| [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) | MIT|59433|2019-08-21|2024-03-15 | 开源 API 开发生态系统，颜值非常高 |
| [Kong/insomnia](https://github.com/Kong/insomnia) | Apache-2.0|32710|2016-04-23|2024-03-15 | 一个开源、跨平台 API 客户端，适用于 GraphQL、REST、WebSockets、服务器发送事件 (SSE)、gRPC 和任何其他 HTTP 兼容协议 |
| [Postcatlab/postcat](https://github.com/Postcatlab/postcat) | Apache-2.0|4794|2021-11-24|2024-01-03 | 一个可扩展的 API 工具平台，支持多平台 |
...
| [YMFE/yapi](https://github.com/YMFE/yapi) | Apache-2.0|26958|2016-05-30|2023-10-25 | 高效、易用、功能强大的 API 管理平台，旨在为开发、产品、测试人员提供优雅的接口管理服务 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [brokercap/Bifrost](https://github.com/brokercap/Bifrost) | Apache-2.0|1824|2018-04-12|2024-02-25 | 面向生产环境的 MySQL, MariaDB, kafka 同步到Redis, MongoDB, ClickHouse, StarRocks, Doris, Kafka等服务的异构中间件 |
| [alibaba/canal](https://github.com/alibaba/canal) | Apache-2.0|27512|2013-01-13|2024-03-08 |  阿里巴巴 MySQL binlog 增量订阅&amp;消费组件 |
| [86dbs/dbsyncer](https://github.com/86dbs/dbsyncer) | Apache-2.0|238|2022-10-11|2024-03-14 |  一款开源的数据同步中间件，提供 MySQL、Oracle、SqlServer、PostgreSQL、Elasticsearch (ES)、Kafka、File、SQL 等同步场景。支持上传插件自定义同步转换业务，提供监控全量和增量数据统计图、应用性能预警等。 |
| [go-mysql-org/go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | MIT|4061|2015-01-15|2023-10-22 | 将 MySQL 数据自动同步到 ES 的工具。它首先用 mysqldump 获取原始数据，然后使用 binlog 增量同步数据 |
| [alibaba/ilogtail](https://github.com/alibaba/ilogtail) | Apache-2.0|1497|2021-11-08|2024-03-15 | 轻量级、高性能、自动化配置的遥测数据(logs, traces, metrics)采集工具 |
| [loggie-io/loggie](https://github.com/loggie-io/loggie) | Apache-2.0|1172|2021-11-22|2024-03-15 |  一个基于 Golang 的轻量级、高性能、云原生日志采集 Agent 和中转处理 Aggregator，支持多 Pipeline 和组件热插拔  |
| [vectordotdev/vector](https://github.com/vectordotdev/vector) | MPL-2.0|15753|2018-08-27|2024-03-15 | 高性能、高可靠、可观察的数据管道, 性能比 Logstash 强很多 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Cloudreve/Cloudreve](https://github.com/Cloudreve/Cloudreve) | GPL-3.0|20528|2018-02-04|2024-03-13 | 支持多家云存储驱动的公有云文件系统 |
| [alist-org/alist](https://github.com/alist-org/alist) | AGPL-3.0|36055|2020-12-23|2024-03-15 | 🗂️ 一个支持多存储的文件列表/WebDAV程序，使用 Gin 和 Solidjs |
| [songquanpeng/go-file](https://github.com/songquanpeng/go-file) | MIT|736|2020-04-08|2023-10-11 | 文件分享工具，仅单个可执行文件，开箱即用，可用于局域网内分享文件和文件夹，直接跑满本地带宽 |
| [jamebal/jmal-cloud-view](https://github.com/jamebal/jmal-cloud-view) | MIT|424|2020-02-09|2024-03-15 | 一款私有云存储网盘项目，能够简单安全管理您的云端文件 |
| [kekingcn/kkFileView](https://github.com/kekingcn/kkFileView) | N/A|9650|2017-12-12|2024-03-13 | 文档在线预览项目解决方案，使用流行的 Spring Boot 框架构建，可轻松设置和部署。 |
| [minio/minio](https://github.com/minio/minio) | AGPL-3.0|43528|2015-01-14|2024-03-15 | MinIO 是一个高性能、兼容 S3 的对象存储 |
| [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) | Apache-2.0|20718|2014-07-14|2024-03-15 | SeaweedFS 是一个快速的分布式存储系统，用于 Blob、对象、文件和数据湖，适用于数十亿个文件！ |
| [tl-open-source/tl-rtc-file](https://github.com/tl-open-source/tl-rtc-file) | MIT|2085|2021-08-05|2024-01-10 | 基于 WebRTC 的媒体流传输工具 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [eryajf/HowToStartOpenSource](https://github.com/eryajf/HowToStartOpenSource) | MIT|872|2022-07-02|2023-10-14 | GitHub 开源项目维护协作指南 |
| [StabilityMan/StabilityGuide](https://github.com/StabilityMan/StabilityGuide) | NOASSERTION|2988|2019-07-10|2023-03-16 | 打造国内稳定性领域知识库，让无法解决的问题少一点点，让世界的确定性多一点点 |
| [eryajf/Thanks-Mirror](https://github.com/eryajf/Thanks-Mirror) | MIT|2413|2022-05-07|2023-12-28 | 整理记录各个包管理器，系统镜像，以及常用软件的好用镜像 |
| [doocs/advanced-java](https://github.com/doocs/advanced-java) | CC-BY-SA-4.0|73771|2018-10-06|2024-02-22 | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识 |
| [fenixsoft/awesome-fenix](https://github.com/fenixsoft/awesome-fenix) | N/A|8354|2019-12-23|2024-01-20 | 讨论如何构建一套可靠的大型分布式系统 |
| [xiaobaiTech/golangFamily](https://github.com/xiaobaiTech/golangFamily) | N/A|4906|2021-01-06|2023-12-23 | 超全 Golang 面试题合集&#43;Golang 学习指南&#43;Golang 知识图谱&#43;入门成长路线 |
| [lifei6671/interview-go](https://github.com/lifei6671/interview-go) | Apache-2.0|4720|2018-02-26|2023-10-16 | Golang 常见面试题目搜集 |
| [chaseSpace/k8s-tutorial-cn](https://github.com/chaseSpace/k8s-tutorial-cn) | NOASSERTION|981|2023-10-26|2024-03-15 | 作者整理的中文 k8s 教程，适合初学者阅读 |
| [caicloud/kube-ladder](https://github.com/caicloud/kube-ladder) | N/A|2423|2019-07-15|2022-11-28 | 文档旨在为广大从业者提供一个 Kubernetes 学习路径，为大家提供一定的指引 |
...
| [jaywcjlove/reference](https://github.com/jaywcjlove/reference) | MIT|9939|2022-09-24|2024-03-15 | 为开发人员分享快速参考备忘清单 |
| [TeamStuQ/skill-map](https://github.com/TeamStuQ/skill-map) | N/A|19765|2015-11-17|2023-01-20 | 程序员技能图谱 |
| [isno/theByteBook](https://github.com/isno/theByteBook) | N/A|5795|2022-10-08|2024-03-15 | 深入讲解内核网络、Kubernetes、ServiceMesh、容器等云原生相关技术，经历实践检验的 DevOps、SRE指南 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [trickstercache/trickster](https://github.com/trickstercache/trickster) | Apache-2.0|1943|2018-03-29|2024-03-13 | HTTP 反向代理/缓存，用于时间序列数据库的仪表板查询加速器 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [GoogleContainerTools/kaniko](https://github.com/GoogleContainerTools/kaniko) | Apache-2.0|13683|2018-01-29|2024-03-13 | 在 Kubernetes 中构建容器镜像 |
| [hashicorp/packer](https://github.com/hashicorp/packer) | NOASSERTION|14819|2013-03-23|2024-03-15 | 一个支持基于配置文件构建机器镜像的工具 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [buger/goreplay](https://github.com/buger/goreplay) | NOASSERTION|18204|2013-05-30|2024-03-10 | 将实时 HTTP 流量捕获和回放到测试环境，也可以作为 HTTP 的抓包工具 |
| [alibaba/jvm-sandbox-repeater](https://github.com/alibaba/jvm-sandbox-repeater) | Apache-2.0|2394|2019-07-03|2023-11-06 | 基于 JVM-Sandbox 的录制/回放通用解决方案 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [AutoMeter/AutoMeter-API](https://github.com/AutoMeter/AutoMeter-API) | MIT|50|2022-09-09|2023-03-10 |  一款针对分布式服务，微服务 API 做功能和性能一体化的自动化测试平台，一站式提供项目管理，微服务，API 接口，用例，环境管理，测试管理，前置条件，测试集合，变量管理，测试计划，Mock，测试报告等  |
| [seagull1985/LuckyFrameWeb](https://github.com/seagull1985/LuckyFrameWeb) | AGPL-3.0|490|2018-02-02|2023-04-10 | 一款免费开源的测试平台，最大的特点是全纬度覆盖了接口自动化、 WEB UI自动化、 APP自动化，并且支持分布式测试，测试关键字驱动也很大程度上解决了测试同学代码基础弱的问题。 |
| [link1st/go-stress-testing](https://github.com/link1st/go-stress-testing) | NOASSERTION|3431|2019-08-15|2024-03-01 | Golang 实现的压测工具 |
| [grafana/k6](https://github.com/grafana/k6) | AGPL-3.0|23003|2016-03-21|2024-03-14 | 一款现代化的负载测试工具，使用 Go 和 JavaScript 实现 |
| [metersphere/metersphere](https://github.com/metersphere/metersphere) | GPL-3.0|10713|2020-02-03|2024-03-15 |  一站式开源持续测试平台，涵盖测试跟踪、接口测试、UI 测试和性能测试等功能，全面兼容 JMeter、Selenium 等主流开源标准  |
| [Runner-Go-Team/runnerGo](https://github.com/Runner-Go-Team/runnerGo) | Apache-2.0|583|2022-10-30|2023-12-21 | 一款全栈式测试平台，可以进行接口测试、场景自动化测试、性能压测等一系列功能 |
| [JoeDog/siege](https://github.com/JoeDog/siege) | GPL-3.0|5755|2014-09-26|2024-01-11 | Siege 是一款用于 http 负载测试和基准测试的工具 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [sohutv/mqcloud](https://github.com/sohutv/mqcloud) | Apache-2.0|1252|2018-10-25|2024-03-13 |  集客户端 SDK，运维，监控，预警等功能的 RocketMQ 企业级一站式服务平台 |
...
| [apache/pulsar](https://github.com/apache/pulsar) | Apache-2.0|13620|2016-06-28|2024-03-15 | Pulsar 是一个分布式 pub-sub 消息传递平台，具有非常灵活的消息传递模型和直观的客户端 API。 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [chaosblade-io/chaosblade](https://github.com/chaosblade-io/chaosblade) | Apache-2.0|5725|2019-03-12|2024-03-12 | 阿里巴巴开源的一款遵循混沌工程原理和混沌实验模型的实验注入工具，帮助企业提升分布式系统的容错能力，并且在企业上云或往云原生系统迁移过程中业务连续性保障 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [xiaodingding/iotfast](https://github.com/xiaodingding/iotfast) | Apache-2.0|290|2022-06-19|2022-08-24 | 基于 Goframe2.0 &#43; Vue3.x 开发的物联网平台，支持跨语言，跨平台接入 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) | N/A|19776|2019-10-09|2024-02-24 | 免费的终端工具，SSH、Telnet、TCP、Shell、串行，支持多平台 |
...
| [withfig/autocomplete](https://github.com/withfig/autocomplete) | MIT|24221|2020-09-29|2024-03-12 | 非常强大的终端命令参数自动补全工具 |
| [wting/autojump](https://github.com/wting/autojump) | NOASSERTION|15862|2009-01-14|2023-10-14 | autojump 是一个快速跳转到目录的命令行工具，它可以记住你经常访问的目录并通过模糊匹配的方式快速跳转到目标目录 |
| [Canop/broot](https://github.com/Canop/broot) | MIT|9904|2018-11-15|2024-03-11 | 获取目录的概览，即使是一个大目录也能快速浏览 |
| [aristocratos/btop](https://github.com/aristocratos/btop) | Apache-2.0|15600|2021-05-06|2024-03-14 | 系统资源监视器显示处理器、内存、磁盘、网络和进程的使用情况和统计​​信息 |
| [RubyMetric/chsrc](https://github.com/RubyMetric/chsrc) | NOASSERTION|225|2023-09-03|2024-01-19 | 一款用 C 语言编写的各语言换源的工具 |
| [cli/cli](https://github.com/cli/cli) | MIT|34928|2019-10-03|2024-03-15 | GitHub的 官方命令行交互工具 |
| [chenquan/diskusage](https://github.com/chenquan/diskusage) | Apache-2.0|255|2022-08-04|2024-03-06 | 💥 显示磁盘使用情况的工具（Linux、MacOS 和 Windows），是一个查找最大目录或文件的非常快速的工具 |
| [Byron/dua-cli](https://github.com/Byron/dua-cli) | MIT|3373|2019-05-29|2024-03-10 | 一个可以方便地了解给定目录的磁盘空间使用情况的工具。可以选择删除多余的数据。 |
| [muesli/duf](https://github.com/muesli/duf) | NOASSERTION|12139|2020-09-20|2024-02-18 | 比 du 更好看的磁盘空间占用查看工具 |
| [bootandy/dust](https://github.com/bootandy/dust) | Apache-2.0|7521|2018-03-16|2024-03-14 | 一个现代的 du (磁盘使用情况) 命令行工具，用于查看磁盘使用情况 |
| [eryajf/eryajfctl](https://github.com/eryajf/eryajfctl) | MIT|13|2023-06-04|2023-08-02 | 🚀 基于 Cobra 库快速打造类似 kubectl 一样的命令行工具箱 🧰 |
| [jhspetersson/fselect](https://github.com/jhspetersson/fselect) | Apache-2.0|3752|2018-01-26|2024-03-06 | 使用类似 SQL 的查询查找文件 |
| [antonmedv/fx](https://github.com/antonmedv/fx) | MIT|18143|2018-01-25|2024-03-15 | go 语言编写的终端下的 json 浏览工具，比 jq 更强大 |
| [heppu/gkill](https://github.com/heppu/gkill) | MIT|312|2017-03-15|2017-04-11 | 运行 gkill 可搜索并选择要终止的进程 |
| [orf/gping](https://github.com/orf/gping) | MIT|10167|2015-10-17|2024-03-14 | 以图形化方式展示 ping 的延迟状态的命令行工具 |
| [tomnomnom/gron](https://github.com/tomnomnom/gron) | MIT|13382|2012-09-08|2023-10-24 | 将 JSON 转换为离散的值，以使其更易于根据需要进行 grep 并查看其绝对路径 |
...
| [htop-dev/htop](https://github.com/htop-dev/htop) | GPL-2.0|5794|2020-08-17|2024-03-15 | 一个跨平台的交互式流程查看器，允许垂直和水平滚动进程列表以查看其完整命令行以及内存和 CPU 消耗等相关信息 |
| [http-party/http-server](https://github.com/http-party/http-server) | MIT|13232|2011-06-16|2024-02-15 | 一个简单的、零配置的命令行静态 HTTP 服务器 |
| [davecheney/httpstat](https://github.com/davecheney/httpstat) | MIT|6469|2016-09-23|2023-10-17 | 显示 HTTP 请求链路详情的工具，便于我们看到请求耗时在什么地方 |
| [kellyjonbrazil/jc](https://github.com/kellyjonbrazil/jc) | MIT|7442|2019-10-15|2024-03-15 | jc 命令可以将常用的 Linux 命令的输出转为 JSON 格式，以便于你再结合 jq 命令进行二次的过滤或处理。 |
| [typicode/json-server](https://github.com/typicode/json-server) | NOASSERTION|70783|2013-11-27|2024-03-08 | 一款能够直接将 json 内容转成 REST API 接口的工具，你可以在日常开发中，通过该工具快速进行调试 |
| [tstack/lnav](https://github.com/tstack/lnav) | BSD-2-Clause|6502|2009-09-14|2024-03-07 | 终端的日志文件查看器，轻松合并、尾随、搜索、过滤和查询日志文件 |
| [johnkerl/miller](https://github.com/johnkerl/miller) | NOASSERTION|8493|2015-05-03|2024-03-12 | 类似于 awk、sed、cut、join 和 sort，用于 CSV、TSV 和表格 JSON 等名称索引数据 |
| [voidcosmos/npkill](https://github.com/voidcosmos/npkill) | MIT|7871|2019-06-30|2023-12-02 | 该工具可以列出系统中的任何 node_modules 目录，以及它们占用的空间。然后，您可以选择要清除哪些文件以释放空间 |
...
| [dalance/procs](https://github.com/dalance/procs) | MIT|4632|2019-01-28|2024-03-13 | 用 Rust 编写的 ps 的现代替代品 |
| [pterm/pterm](https://github.com/pterm/pterm) | MIT|4488|2020-09-17|2024-03-14 | 一个现代的 Go 模块，可以轻松美化控制台输出。具有图表、进度条、表格、树、文本输入、选择菜单等 |
| [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) | Unlicense|43958|2016-03-11|2024-03-11 | 一个面向行的搜索工具，它递归地搜索当前目录中的正则表达式模式。默认情况下，ripgrep 将遵守 gitignore 规则并自动跳过隐藏文件/目录和二进制文件。 |
| [sqshq/sampler](https://github.com/sqshq/sampler) | GPL-3.0|11996|2019-01-25|2024-02-22 | Sampler 是一个用于 shell 命令执行、可视化和警报的工具。使用简单的 YAML 文件进行配置。 |
| [chmln/sd](https://github.com/chmln/sd) | MIT|5227|2018-12-23|2024-02-26 | 与sed命令类似，但提供更加直观的查找和替换能力 |
| [Aloxaf/silicon](https://github.com/Aloxaf/silicon) | MIT|2909|2019-07-07|2024-03-11 | 一款能够将代码创建为漂亮的图片渲染的工具 |
| [lotabout/skim](https://github.com/lotabout/skim) | MIT|4753|2016-05-29|2024-03-12 | 一个类似 grep 命令的通用的模糊查找器，可以节省您的时间。 |
| [XiaoMi/soar](https://github.com/XiaoMi/soar) | Apache-2.0|8574|2018-10-08|2023-12-15 | 一个对 SQL 进行优化和改写的自动化工具，支持多平台 |
| [Eugeny/tabby](https://github.com/Eugeny/tabby) | MIT|54290|2016-12-23|2024-03-12 | 一款开源的跨平台支持的终端程序，能够方便地管理主机连接 |
| [homeport/termshot](https://github.com/homeport/termshot) | MIT|351|2020-11-10|2024-03-05 | 根据终端命令输出创建屏幕截图 |
...
| [chubin/wttr.in](https://github.com/chubin/wttr.in) | Apache-2.0|23406|2015-12-26|2024-03-07 | 执行 curl wttr.in 在终端中显示天气预报 |
| [BurntSushi/xsv](https://github.com/BurntSushi/xsv) | Unlicense|9989|2014-09-02|2024-02-24 | 一个用于索引、切片、分析、分割和连接 CSV 文件的命令行程序。 |
| [mikefarah/yq](https://github.com/mikefarah/yq) | MIT|10519|2015-09-26|2024-03-14 | 款基于 go 语言编写类似 jq 的处理 yaml 文件的工具 |
| [bvaisvil/zenith](https://github.com/bvaisvil/zenith) | MIT|2097|2019-09-16|2024-03-04 | 类似 top 或 htop，还具有可缩放图表、CPU、GPU、网络和磁盘使用情况的能力 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [instantbox/instantbox](https://github.com/instantbox/instantbox) | MIT|3697|2018-12-11|2024-03-12 | 在不到 30s 内得到一个干净、开箱即用的临时 Linux 系统 |
| [utmapp/utm](https://github.com/utmapp/utm) | Apache-2.0|23651|2019-04-12|2024-03-15 | 适用于 iOS 和 MacOS 的虚拟机工具 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [1Panel-dev/1Panel](https://github.com/1Panel-dev/1Panel) | GPL-3.0|16422|2022-07-19|2024-03-15 | 现代化、开源的 Linux 服务器运维管理面板 |
| [TeaOSLab/EdgeAdmin](https://github.com/TeaOSLab/EdgeAdmin) | BSD-3-Clause|923|2020-06-27|2024-03-15 | CDN &amp; WAF集群管理系统 |
| [welliamcao/OpsManage](https://github.com/welliamcao/OpsManage) | GPL-2.0|3210|2017-04-30|2024-02-25 | 代码部署、应用部署、计划任务、设备资产管理平台 |
| [alibaba/SREWorks](https://github.com/alibaba/SREWorks) | Apache-2.0|1677|2022-03-16|2023-10-16 | 阿里巴巴大数据 SRE 团队开源的一个运维 SaaS 应用，特点有云原生，数智华 |
...
| [idcos/cloudiac](https://github.com/idcos/cloudiac) | Apache-2.0|109|2021-08-04|2024-03-12 | 基于基础设施即代码构建的云环境自动化管理平台 |
| [cockpit-project/cockpit](https://github.com/cockpit-project/cockpit) | LGPL-2.1|10077|2013-11-01|2024-03-15 | Cockpit 是一个基于 Web 的服务器图形界面 |
| [datavane/datasophon](https://github.com/datavane/datasophon) | Apache-2.0|878|2022-10-11|2024-03-12 | 云原生大数据管家，致力于帮助用户快速构建起稳定、高效、可弹性伸缩的大数据云原生平台 |
| [data-observe/datav](https://github.com/data-observe/datav) | NOASSERTION|3566|2017-09-28|2024-03-14 | 一个现代化的数据可视化平台，构建于 2023 年，可以对 Metrics,  Traces 和 Logs 数据进行深度可视化和交互操作 |
| [512team/dhorse](https://github.com/512team/dhorse) | Apache-2.0|369|2022-10-16|2024-03-12 | 一个轻量级、简单易用的云应用管理平台，具有多云和多环境管理、应用管理和部署、服务治理等功能 |
| [mouday/domain-admin](https://github.com/mouday/domain-admin) | MIT|1235|2022-09-23|2024-03-05 | 基于Python &#43; Vue3.js 技术栈实现的域名和SSL证书监测平台 |
...
| [theforeman/foreman](https://github.com/theforeman/foreman) | GPL-3.0|2475|2009-07-23|2024-03-15 | 一个免费的开源项目，使您能够轻松地自动执行重复性任务、快速部署应用程序并主动管理本地或云中的服务器生命周期。 |
| [harness/gitness](https://github.com/harness/gitness) | Apache-2.0|31246|2014-02-07|2024-03-14 | Gitness 是一个开发者用的开源平台，具备源代码控制管理、持续集成和持续交付等功能。 |
| [dromara/mayfly-go](https://github.com/dromara/mayfly-go) | Apache-2.0|1621|2021-04-16|2024-03-15 | web 版 Linux(终端, 文件脚本, 进程, 计划任务)、数据库（MySQL, Postgres, 达梦）、Redis(单机, 哨兵, 集群)、MongoDB 统一管理操作平台 |
| [CloudWise-OpenSource/omp](https://github.com/CloudWise-OpenSource/omp) | GPL-3.0|244|2021-11-30|2023-09-28 | 轻量级、聚合型、智能运维管理平台 |
| [ssbeatty/oms](https://github.com/ssbeatty/oms) | AGPL-3.0|156|2020-08-20|2024-02-21 | 一个 Golang 开发的简单易用的运维管理平台，实现了资产管理、文件浏览器、批量命令、批量上传文件、VNC 连接和基于自建脚本并行执行的能力 |
| [TheTNB/panel](https://github.com/TheTNB/panel) | AGPL-3.0|361|2022-12-01|2024-03-15 | 耗子 Linux 面板是使用 Golang &#43; Vue 开发的轻量 Linux 服务器运维管理面板 |
| [wuranxu/pity](https://github.com/wuranxu/pity) | Apache-2.0|582|2021-03-06|2024-02-06 | 一款专注于api自动化的工具，采用Python&#43;FastApi&#43;React开发 |
| [chaitin/safeline](https://github.com/chaitin/safeline) | NOASSERTION|8212|2023-04-12|2024-03-15 | 一款足够简单、足够好用、足够强的免费 WAF。基于业界领先的语义引擎检测技术，作为反向代理接入，保护你的网站不受黑客攻击 |
| [ansible-semaphore/semaphore](https://github.com/ansible-semaphore/semaphore) | MIT|8954|2014-08-23|2024-03-12 | Ansible 的现代化用户界面 |
| [openspug/spug](https://github.com/openspug/spug) | AGPL-3.0|9669|2018-01-31|2024-02-27 | 轻量级无 Agent 的自动化运维平台 |
| [opentdp/tdp-cloud](https://github.com/opentdp/tdp-cloud) | GPL-3.0|322|2022-05-29|2024-03-01 | 土豆片多云资源管理系统 |
| [team-ide/teamide](https://github.com/team-ide/teamide) | Apache-2.0|553|2021-11-30|2024-03-11 | 集成 MySQL、Oracle、金仓、达梦、神通等数据库、SSH、FTP、Redis、Zookeeper、Kafka、Elasticsearch 等管理工具 |
| [test-instructor/yangfan](https://github.com/test-instructor/yangfan) | Apache-2.0|105|2022-07-23|2023-11-16 | 一款高效、可靠的自动化测试平台，旨在帮助团队提升测试效率、降低测试成本 |
| [MirrorX-Desktop/MirrorX](https://github.com/MirrorX-Desktop/MirrorX) | GPL-3.0|769|2022-03-09|2023-05-16 | 基于 Rust 构建的远程桌面控制软件 |
| [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | AGPL-3.0|60856|2020-09-28|2024-03-15 | 一个远程桌面软件，用 Rust 编写。开箱即用，无需配置。您可以完全控制您的数据，无需担心安全性。 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [ansible/ansible](https://github.com/ansible/ansible) | GPL-3.0|60629|2012-03-06|2024-03-15 | 一个极其简单的 IT 自动化平台，使您的应用程序和系统更易于部署和维护，基于 ssh，无需客户端 |
| [capistrano/capistrano](https://github.com/capistrano/capistrano) | MIT|12629|2009-02-26|2024-03-10 | 一个利用 Ruby、Rake 和 SSH 构建的部署自动化工具。 |
| [chef/chef](https://github.com/chef/chef) | Apache-2.0|7426|2009-01-15|2024-03-14 | Chef Infra 是一个高效的自动化平台，它将基础设施转化成可编程代码，实现了基础设施配置、部署和管理在任何环境、任何规模下的自动化。 |
| [fabric/fabric](https://github.com/fabric/fabric) | BSD-2-Clause|14514|2009-05-01|2024-01-26 | 一种简单、具有 Python 风格的远程执行和部署方法。 |
| [puppetlabs/puppet](https://github.com/puppetlabs/puppet) | Apache-2.0|7232|2010-09-14|2024-03-15 | 服务器自动化框架和应用程序 |
| [saltstack/salt](https://github.com/saltstack/salt) | Apache-2.0|13775|2011-02-20|2024-03-15 | 该软件能自动化管理和配置任何规模的基础设施或应用程序。 |
| [StackStorm/st2](https://github.com/StackStorm/st2) | Apache-2.0|5863|2014-04-23|2024-03-15 | StackStorm (俗称&#34;运维领域的 IFTTT&#34;) 是一个事件驱动的自动化工具，用于自动修复、应对突发事件、故障排查、软件部署等多种运维任务，特别适用于 DevOps 和 SREs。 |
| [hashicorp/terraform](https://github.com/hashicorp/terraform) | NOASSERTION|40843|2014-03-13|2024-03-15 | Terraform 让您能够安全且可预测地创建、更改和改进基础设施。 |
| [tsuru/tsuru](https://github.com/tsuru/tsuru) | BSD-3-Clause|4616|2012-03-05|2024-03-14 | 这是一个开源并且具备扩展性的平台即服务 (PaaS)。 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [apolloconfig/apollo](https://github.com/apolloconfig/apollo) | Apache-2.0|28700|2016-03-04|2024-02-21 | Apollo（阿波罗）是一款可靠的分布式配置管理中心，诞生于携程框架研发部，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。 |
| [alibaba/nacos](https://github.com/alibaba/nacos) | Apache-2.0|28737|2018-06-15|2024-03-15 | 一个易于使用的动态服务发现、配置和服务管理平台，用于构建云原生应用程序。 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [apernet/OpenGFW](https://github.com/apernet/OpenGFW) | MPL-2.0|8193|2023-12-13|2024-03-14 | OpenGFW 是一个 Linux 上灵活、易用、开源的 GFW 实现，并且在许多方面比真正的 GFW 更强大 |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [kuaifan/dootask](https://github.com/kuaifan/dootask) | AGPL-3.0|4111|2021-08-29|2024-03-15 |  一款开源在线项目任务管理工具，提供各类文档协作工具、在线思维导图、在线流程图、项目管理、任务分发、即时IM，文件管理等工具 |
| [easysoft/zentaopms](https://github.com/easysoft/zentaopms) | NOASSERTION|1199|2011-01-30|2024-03-15 |  禅道是第一款国产的开源项目管理软件。它集产品管理、项目管理、质量管理、文档管理、 组织管理和事务管理于一体，是一款专业的研发项目管理软件，完整地覆盖了项目管理的核心流程。 |
