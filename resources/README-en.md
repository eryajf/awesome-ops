...
<p>🧐 Divided into 66 categories. 📥 Includes 375 entries.</p>
...
|:-:|:-:|:-:|:-:|:-:|:-:|
| [jeessy2/backup-x](https://github.com/jeessy2/backup-x) | MIT | 237 | 2021-11-13 | 2023-12-15 | A database/file backup tool with web interfaces |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [dromara/Jpom](https://github.com/dromara/Jpom) | MIT | 1079 | 2019-01-04 | 2024-01-18 | Simple and light low-intrusion online build, automatic deployment, daily operation and maintenance, project monitoring software |
| [argoproj/argo-cd](https://github.com/argoproj/argo-cd) | Apache-2.0 | 15180 | 2018-02-09 | 2024-01-20 | Declarative Continuous Deployment for Kubernetes |
| [dagger/dagger](https://github.com/dagger/dagger) | Apache-2.0 | 9480 | 2019-11-20 | 2024-01-20 | Application Delivery as Code that Runs Anywhere |
...
| [pipe-cd/pipecd](https://github.com/pipe-cd/pipecd) | Apache-2.0 | 919 | 2020-06-12 | 2024-01-19 | The One CD for All {applications, platforms, operations} |
...
| [koderover/zadig](https://github.com/koderover/zadig) | NOASSERTION | 2533 | 2021-05-12 | 2024-01-19 | Self-service cloud native DevOps platform based on Kubernetes |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) | MIT | 1335 | 2021-12-29 | 2024-01-18 | A lightweight browser-based log analysis and query platform, the underlying data storage uses ClickHouse |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [jhuckaby/Cronicle](https://github.com/jhuckaby/Cronicle) | NOASSERTION | 3017 | 2016-01-08 | 2024-01-05 | A simple, distributed task scheduler and runner with a web based UI. |
| [ouqiang/gocron](https://github.com/ouqiang/gocron) | MIT | 5447 | 2017-02-20 | 2023-12-13 | A Golang light weight job scheduling system |
...
| [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) | MIT | 7968 | 2020-08-26 | 2024-01-20 | Automatically get your public IP address and resolve it to the corresponding domain name service, support Aliyun, Tencent Cloud, DNSpod, Cloudflare, Huawei Cloud, Callback, Baidu Cloud, Porkbun, GoDaddy, Google, Domain, Namecheap, NameSilo |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Snapchat/KeyDB](https://github.com/Snapchat/KeyDB) | BSD-3-Clause | 8571 | 2019-02-01 | 2024-01-10 | KeyDB is a high performance fork of Redis with a focus on multithreading, memory efficiency, and high throughput. In addition to performance improvements, KeyDB offers features such as Active Replication, FLASH Storage and Subkey Expires. |
...
| [dragonflydb/dragonfly](https://github.com/dragonflydb/dragonfly) | NOASSERTION | 22120 | 2021-12-11 | 2024-01-20 | Dragonfly is an in-memory database built for modern applications load demands, fully compatible with Redis and Memcached APIs, and no code changes are required when migrating. Compared to these traditional in-memory databases, Dragonfly offers 25 times the throughput, high cache hit rates and low tail latency, and can reduce resources for the same size workload by up to 80%. |
| [apache/kvrocks](https://github.com/apache/kvrocks) | Apache-2.0 | 2744 | 2019-08-15 | 2024-01-20 | A distributed key-value NoSQL database, using RocksDB as the storage engine, compatible with the Redis protocol. |
...
| [OpenAtomFoundation/pika](https://github.com/OpenAtomFoundation/pika) | BSD-3-Clause | 5493 | 2014-11-03 | 2024-01-20 | Pika is a large-capacity, high-performance, multi-tenant, data-persistent elastic KV data storage system based on RocksDB. It is fully compatible with the Redis protocol and supports its common data structures. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [cosmtrek/air](https://github.com/cosmtrek/air) | GPL-3.0 | 13603 | 2017-10-12 | 2024-01-19 | ☁️ A hot-reloading CLI tool designed for Go applications development |
| [curlconverter/curlconverter](https://github.com/curlconverter/curlconverter) | MIT | 6902 | 2014-12-25 | 2024-01-05 | A tool that can convert curl commands into requests in various languages |
| [golangci/golangci-lint](https://github.com/golangci/golangci-lint) | GPL-3.0 | 13892 | 2018-05-04 | 2024-01-20 | Fast linters runner for Go. 5x faster than gometalinter. Nice colored output. Can report only new issues. Fewer false-positives. Yaml/toml config. Highly customizable. Many linters. Fewer mistakes. CI-integrated. Used by Uber, The New York Times, GitLab, HashiCorp, OpenShift and others. |
| [AykutSarac/jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com) | GPL-3.0 | 27008 | 2022-01-30 | 2024-01-20 | A tool that converts various data formats such as JSON, YAML, XML, CSV, etc. into interactive charts |
| [massCodeIO/massCode](https://github.com/massCodeIO/massCode) | AGPL-3.0 | 5260 | 2022-03-29 | 2024-01-20 | An open source local code snippet management tool |
| [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) | BSD-3-Clause | 44284 | 2018-06-25 | 2024-01-19 | A simple zero-config tool to make locally trusted development certificates with any names you d like |
...
| [ritz078/transform](https://github.com/ritz078/transform) | MIT | 6655 | 2017-06-15 | 2023-12-27 | Multi-format file conversion tool, such as JSON to struct, etc. |
...
| [moby/buildkit](https://github.com/moby/buildkit) | Apache-2.0 | 7411 | 2017-05-31 | 2024-01-20 | Enhance the function of Docker build, support parallel build, cache, image export and other functions |
| [abiosoft/colima](https://github.com/abiosoft/colima) | MIT | 15427 | 2021-09-04 | 2024-01-04 | Container runtime for MacOS and Linux, with minimal setup |
| [bcicen/ctop](https://github.com/bcicen/ctop) | MIT | 14922 | 2016-12-27 | 2023-10-18 |  A command line tool for container metrics  |
| [wagoodman/dive](https://github.com/wagoodman/dive) | MIT | 41917 | 2018-05-13 | 2024-01-13 | A tool for exploring a docker image, layer contents, and discovering ways to shrink the size of your Docker/OCI image |
...
| [louislam/dockge](https://github.com/louislam/dockge) | MIT | 6472 | 2023-10-23 | 2024-01-19 | A fancy, easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager |
| [amir20/dozzle](https://github.com/amir20/dozzle) | MIT | 3660 | 2018-10-30 | 2024-01-19 | Dozzle is a small lightweight application with a web based interface to monitor Docker logs. It doesn’t store any log files. It is for live monitoring of your container logs only. |
| [goharbor/harbor](https://github.com/goharbor/harbor) | Apache-2.0 | 21594 | 2016-01-28 | 2024-01-19 | The most well-known and probably the most widely used Docker image repository within the enterprise |
| [jesseduffield/lazydocker](https://github.com/jesseduffield/lazydocker) | MIT | 32051 | 2019-05-18 | 2024-01-15 | A simple terminal UI for both docker and docker-compose, written in Go with the gocui library. |
| [portainer/portainer](https://github.com/portainer/portainer) | Zlib | 27802 | 2016-05-19 | 2024-01-19 | Making Docker and Kubernetes management easy. |
| [quay/quay](https://github.com/quay/quay) | Apache-2.0 | 2306 | 2019-11-08 | 2024-01-20 | Red Hat open source Docker image repository, similar to Harbor |
...
| [slimtoolkit/slim](https://github.com/slimtoolkit/slim) | Apache-2.0 | 17719 | 2015-09-09 | 2024-01-20 | Do not change anything in your Docker container image and shrink it by up to 30x (for compiled languages even more) making it secure too! |
| [krallin/tini](https://github.com/krallin/tini) | MIT | 9229 | 2015-02-27 | 2023-02-08 | A tiny but valid init for containers, PID 1, or init for short, is the first process launched in a new Unix session. It typically executes the init system, which is responsible for starting and managing services. |
...
| [cars10/elasticvue](https://github.com/cars10/elasticvue) | MIT | 1485 | 2017-08-08 | 2024-01-19 | A free and open-source Elasticsearch GUI that supports the latest version of Elasticsearch 8.x and 7.x. 6.8. It supports desktop, browser plugins and docker |
...
| [tiny-craft/tiny-rdm](https://github.com/tiny-craft/tiny-rdm) | GPL-3.0 | 3015 | 2023-06-27 | 2024-01-20 | A modern lightweight cross-platform Redis desktop manager, suitable for Mac, Windows and Linux. High face value, rich in functions. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) | NOASSERTION | 6221 | 2020-06-11 | 2024-01-16 | MySQL/MariaDB database management for macOS |
| [antares-sql/antares](https://github.com/antares-sql/antares) | MIT | 1382 | 2020-04-30 | 2024-01-20 | Support MySQL/MariaDB, PostgreSQL, SQLite and Firebird SQL, support multi-platform |
| [beekeeper-studio/beekeeper-studio](https://github.com/beekeeper-studio/beekeeper-studio) | GPL-3.0 | 14374 | 2019-07-23 | 2024-01-19 | Modern and easy to use SQL client for MySQL, Postgres, SQLite, SQL Server, and more. Written with Electron &amp; Vue.js |
| [sqlitebrowser/sqlitebrowser](https://github.com/sqlitebrowser/sqlitebrowser) | NOASSERTION | 19484 | 2014-05-04 | 2024-01-20 | A high quality, visual, open source tool to create, design, and edit database files compatible with SQLite. |
...
| [eolinker/apinto](https://github.com/eolinker/apinto) | Apache-2.0 | 1114 | 2021-07-19 | 2024-01-19 | Gateway developed based on golang, with various plug-ins, which can be extended by itself, plug and play. It can quickly help enterprises manage API services and improve the stability and security of API services |
...
| [apache/apisix](https://github.com/apache/apisix) | Apache-2.0 | 13264 | 2019-04-10 | 2024-01-19 | A cloud-native microservices API gateway, delivering the ultimate performance, security, open source and scalable platform for all your APIs and microservices. |
...
| [alibaba/higress](https://github.com/alibaba/higress) | Apache-2.0 | 2038 | 2022-10-27 | 2024-01-19 | Higress implements three-layer gateways, including security protection gateway, traffic gateway and microservice gateway, which can significantly reduce the deployment and operation and maintenance costs of gateways. |
| [Kong/kong](https://github.com/Kong/kong) | Apache-2.0 | 36705 | 2014-11-17 | 2024-01-20 | A cloud-native, platform-agnostic, scalable API Gateway distinguished for its high performance and extensibility via plugins. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [PGYER/codefever](https://github.com/PGYER/codefever) | MIT | 2563 | 2022-01-19 | 2023-12-12 | Self-hosted Git server with CI/CD and Kanban |
| [go-gitea/gitea](https://github.com/go-gitea/gitea) | MIT | 40224 | 2016-11-01 | 2024-01-20 | Includes git repository hosting, code review, issue tracking, team collaboration, and CI/CD. Powerful, worth a try. Fork from Gogs |
| [gogs/gogs](https://github.com/gogs/gogs) | MIT | 43652 | 2014-02-12 | 2024-01-01 | The simplest, fastest and easiest way to build a self-service Git service, developed on Golang and supporting multiple platforms. |
| [theonedev/onedev](https://github.com/theonedev/onedev) | MIT | 12194 | 2018-11-06 | 2024-01-20 | A completely free and open source Git code hosting service that supports one-line command installation to your own server |
...
| [yunionio/cloudpods](https://github.com/yunionio/cloudpods) | Apache-2.0 | 2195 | 2018-07-27 | 2024-01-19 | Open source, cloud-native multi-cloud and hybrid cloud fusion platform |
| [headlamp-k8s/headlamp](https://github.com/headlamp-k8s/headlamp) | Apache-2.0 | 1366 | 2019-11-08 | 2024-01-20 | Headlamp is an easy-to-use and extensible Kubernetes web UI. |
...
| [derailed/k9s](https://github.com/derailed/k9s) | Apache-2.0 | 23605 | 2019-01-25 | 2024-01-19 | Kubernetes CLI To Manage Your Clusters In Style! |
...
| [eip-work/kuboard-press](https://github.com/eip-work/kuboard-press) | N/A | 20389 | 2019-07-24 | 2024-01-10 | K8s multi-cluster management platform, the open source free version only supports up to 3 clusters |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [alibaba/Sentinel](https://github.com/alibaba/Sentinel) | Apache-2.0 | 21725 | 2018-04-04 | 2024-01-12 | A powerful flow control component enabling reliability, resilience and monitoring for microservices. |
...
| [k8gb-io/k8gb](https://github.com/k8gb-io/k8gb) | Apache-2.0 | 698 | 2019-11-27 | 2024-01-20 | Fully open source, cloud native, global load balancing solution for Kubernetes |
...
| [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) | Apache-2.0 | 10227 | 2021-04-19 | 2024-01-20 | API traffic analyzer for K8s, providing real-time protocol-level visibility into your K8s internal network, capturing and monitoring all traffic and load across containers, pods, nodes and clusters |
| [traefik/traefik](https://github.com/traefik/traefik) | MIT | 46301 | 2015-09-13 | 2024-01-20 | A modern HTTP reverse proxy and load balancer that makes it easy to deploy microservices |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [stakater/Reloader](https://github.com/stakater/Reloader) | Apache-2.0 | 6220 | 2018-07-04 | 2024-01-20 | A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig |
...
| [komodorio/helm-dashboard](https://github.com/komodorio/helm-dashboard) | Apache-2.0 | 4552 | 2022-08-22 | 2024-01-20 | The missing UI for Helm - visualize your releases |
...
| [kedacore/keda](https://github.com/kedacore/keda) | Apache-2.0 | 7417 | 2019-02-13 | 2024-01-19 | KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes |
...
| [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) | Apache-2.0 | 12429 | 2018-09-12 | 2024-01-20 | Kubernetes IN Docker - local clusters for testing Kubernetes |
| [kubernetes/kompose](https://github.com/kubernetes/kompose) | Apache-2.0 | 8929 | 2016-06-27 | 2024-01-19 | Convert Docker Compose to Kubernetes |
...
| [aquasecurity/kube-bench](https://github.com/aquasecurity/kube-bench) | Apache-2.0 | 6443 | 2017-06-19 | 2024-01-20 | Checks whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark |
...
| [easzlab/kubeasz](https://github.com/easzlab/kubeasz) | N/A | 9828 | 2017-11-12 | 2024-01-18 |  Install K8S cluster with Ansible script, introduce component interaction principle, convenient and direct, not affected by domestic network environment  |
...
| [itaysk/kubectl-neat](https://github.com/itaysk/kubectl-neat) | Apache-2.0 | 1480 | 2019-07-22 | 2024-01-09 | A tool that can intelligently clear the useless output when kubectl get pod -o yaml, making it easier to read |
| [ahmetb/kubectx](https://github.com/ahmetb/kubectx) | Apache-2.0 | 16428 | 2017-03-30 | 2023-12-26 | Faster way to switch between clusters and namespaces in kubectl |
...
| [postfinance/kubenurse](https://github.com/postfinance/kubenurse) | MIT | 347 | 2018-10-04 | 2024-01-19 | kubenurse is a little service that monitors all network connections in a Kubernetes cluster. Kubenurse measures request durations, records errors and exports those metrics in Prometheus format. |
...
| [danielfoehrKn/kubeswitch](https://github.com/danielfoehrKn/kubeswitch) | Apache-2.0 | 692 | 2019-12-30 | 2023-12-19 | A k8s multi-cluster configuration file management switching tool |
...
| [instrumenta/kubeval](https://github.com/instrumenta/kubeval) | NOASSERTION | 3109 | 2017-06-25 | 2023-08-08 | Validate your Kubernetes configuration files, supports multiple Kubernetes versions |
...
| [kubeshop/monokle](https://github.com/kubeshop/monokle) | MIT | 1441 | 2021-06-04 | 2024-01-11 | Better create, understand and deploy YAML manifests with a visual UI that also offers policy validation and cluster insights |
...
| [bitnami-labs/sealed-secrets](https://github.com/bitnami-labs/sealed-secrets) | Apache-2.0 | 6851 | 2017-05-29 | 2024-01-18 | A Kubernetes controller and tool for one-way encrypted Secrets |
| [labring/sealos](https://github.com/labring/sealos) | Apache-2.0 | 12355 | 2018-08-15 | 2024-01-20 | A Cloud Operating System designed for managing cloud-native applications |
| [GoogleContainerTools/skaffold](https://github.com/GoogleContainerTools/skaffold) | Apache-2.0 | 14445 | 2018-01-23 | 2024-01-20 | Easy and Repeatable Kubernetes Development |
...
| [jrhouston/tfk8s](https://github.com/jrhouston/tfk8s) | MIT | 884 | 2020-04-28 | 2024-01-17 | A tool for converting Kubernetes YAML manifests to Terraform HCL |
...
| [provectus/kafka-ui](https://github.com/provectus/kafka-ui) | Apache-2.0 | 7770 | 2019-11-26 | 2024-01-20 | A Kafka-Web management background written in Python&#43;Vue |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | Apache-2.0 | 10210 | 2018-09-30 | 2024-01-20 | Fast, economical and efficient monitoring solution and time series database, which can be used for storage of Prometheus or Grafana |
...
| [dromara/hertzbeat](https://github.com/dromara/hertzbeat) | Apache-2.0 | 3987 | 2022-02-04 | 2024-01-20 | Easy-to-use and friendly open source real-time monitoring and alarm system, no need for Agent, high-performance cluster, compatible with Prometheus, powerful custom monitoring capabilities |
...
| [prymitive/karma](https://github.com/prymitive/karma) | Apache-2.0 | 2133 | 2018-09-09 | 2024-01-20 | A panel that displays AlertManager alarm information, which can be used for screen projection |
| [ccfos/nightingale](https://github.com/ccfos/nightingale) | Apache-2.0 | 8285 | 2020-03-03 | 2024-01-19 | All-in-One cloud native monitoring tool, which combines the advantages of Prometheus and Grafana. You can manage and configure alarm strategies on the WebUI, and you can also visualize and analyze metrics, logs, and link tracking data distributed in multiple regions |
| [SigNoz/signoz](https://github.com/SigNoz/signoz) | NOASSERTION | 15992 | 2021-01-03 | 2024-01-19 | SigNoz is an open-source observability platform native to OpenTelemetry with logs, traces and metrics in a single application. An open-source alternative to DataDog, NewRelic, etc. Open source Application Performance Monitoring (APM) &amp; Observability tool |
| [mikecao/umami](https://github.com/mikecao/umami) | MIT | 18267 | 2020-07-17 | 2024-01-19 | Easy to build and configure, elegant and beautiful site access statistics tool |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [dromara/MaxKey](https://github.com/dromara/MaxKey) | Apache-2.0 | 1068 | 2016-11-16 | 2024-01-10 | The industry-leading IAM-IDaas identity management and authentication product supports standard protocols such as OAuth 2.x/OpenID Connect, SAML 2.0, JWT, CAS, SCIM, etc., providing secure, standard and open user identity management (IDM), identity authentication (AM), Single sign-on (SSO), RBAC permission management and resource management, etc. |
| [logto-io/logto](https://github.com/logto-io/logto) | MPL-2.0 | 6748 | 2021-06-19 | 2024-01-20 | An Auth0 alternative designed for modern applications and SaaS products. It provides a seamless developer experience and is great for individuals and growing companies |
| [zitadel/zitadel](https://github.com/zitadel/zitadel) | Apache-2.0 | 5996 | 2020-03-16 | 2024-01-19 | Enterprise-level unified identity authentication management system |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [glauth/glauth](https://github.com/glauth/glauth) | MIT | 2177 | 2018-04-25 | 2024-01-19 | A system based on golang to realize the functions of ldap, which supports local, S3, original ldap, MySQL and other storage methods. There are slight differences in usage habits from ldap |
...
| [composer/composer](https://github.com/composer/composer) | MIT | 28032 | 2011-06-08 | 2024-01-19 | Private server program for PHP language stack |
| [dzikoysk/reposilite](https://github.com/dzikoysk/reposilite) | Apache-2.0 | 1148 | 2017-07-06 | 2024-01-20 | Lightweight and easy to use repository manager for JVM ecosystem based on Maven |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [nginxinc/nginx-prometheus-exporter](https://github.com/nginxinc/nginx-prometheus-exporter) | Apache-2.0 | 1416 | 2018-05-30 | 2024-01-18 | NGINX Prometheus Exporter for NGINX and NGINX Plus |
| [prometheus/node_exporter](https://github.com/prometheus/node_exporter) | Apache-2.0 | 9819 | 2013-04-18 | 2024-01-16 | Exporter for machine metrics |
...
| [sohutv/cachecloud](https://github.com/sohutv/cachecloud) | Apache-2.0 | 8226 | 2016-01-26 | 2023-12-25 | Support Redis multi-architecture (Standalone, Sentinel, Cluster) efficient management, effectively reduce the large-scale redis operation and maintenance costs, improve resource management capabilities and utilization. The platform provides fast build/migration, operation and maintenance management, elastic scaling, statistical monitoring, client integration access and other functions |
...
| [Bytebase/Bytebase](https://github.com/Bytebase/Bytebase) | NOASSERTION | 9207 | 2021-01-27 | 2024-01-20 | The world most advanced database DevOps and CI/CD for developers, DBAs and platform engineering teams |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) | MIT | 41276 | 2018-04-23 | 2024-01-19 | ⚡ Lightning Fast, Ultra Relevant, and Typo-Tolerant Search Engine written in Rust 🔍 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | AGPL-3.0 | 7944 | 2023-02-02 | 2024-01-20 | A cloud-native observability platform, built for logs, metrics, traces, analytics, and RUM (Real User Monitoring - performance, errors, session replay), designed for PB scale workloads |
| [zincsearch/zincsearch](https://github.com/zincsearch/zincsearch) | NOASSERTION | 15963 | 2021-12-02 | 2024-01-14 | A search engine for full-text indexing. It is a lightweight alternative to Elasticsearch and uses only a small fraction of resources at runtime. It uses blue as the underlying index library |
...
| [localsend/localsend](https://github.com/localsend/localsend) | MIT | 26988 | 2022-12-16 | 2024-01-20 | A free, open-source application that allows you to securely share files and messages with nearby devices on your local network without an internet connection |
| [lra/mackup](https://github.com/lra/mackup) | GPL-3.0 | 13926 | 2013-04-06 | 2024-01-19 | A tool that keeps your application configuration in sync |
| [mtlynch/picoshare](https://github.com/mtlynch/picoshare) | NOASSERTION | 1971 | 2022-02-14 | 2024-01-16 | A file sharing service that supports multiple types, easy to deploy and easy to use |
| [syncthing/syncthing](https://github.com/syncthing/syncthing) | MPL-2.0 | 57571 | 2013-11-26 | 2024-01-17 | Open source cross-platform file synchronization tool |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [voidint/g](https://github.com/voidint/g) | MIT | 1456 | 2019-04-25 | 2023-12-27 | Another one for managing and switching multiple Golang versions |
| [moovweb/gvm](https://github.com/moovweb/gvm) | MIT | 9230 | 2011-12-03 | 2023-11-11 | A simple tool for managing and switching multiple Golang versions |
...
| [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) | MIT | 32844 | 2014-09-20 | 2024-01-18 | For managing and switching multiple Node versions in Windows system |
| [nvm-sh/nvm](https://github.com/nvm-sh/nvm) | MIT | 73163 | 2010-04-15 | 2024-01-20 | A simple tool for managing and switching multiple Node versions |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [BookStackApp/BookStack](https://github.com/BookStackApp/BookStack) | MIT | 13119 | 2015-08-29 | 2024-01-19 | A platform to create documentation/wiki content built with PHP &amp; Laravel |
| [zmister2016/MrDoc](https://github.com/zmister2016/MrDoc) | GPL-3.0 | 2701 | 2020-04-10 | 2024-01-20 | online document system developed based on python. It is suitable for individuals and small teams to manage documents, wiki, knowledge and notes.  |
| [facebook/docusaurus](https://github.com/facebook/docusaurus) | MIT | 50824 | 2017-06-20 | 2024-01-19 | A project for easily building, deploying, and maintaining open source project websites |
| [halo-dev/halo](https://github.com/halo-dev/halo) | GPL-3.0 | 30280 | 2018-03-21 | 2024-01-19 | Powerful and easy-to-use open source website building tools, more biased towards blog style |
| [usememos/memos](https://github.com/usememos/memos) | MIT | 22387 | 2021-12-08 | 2024-01-20 | A privacy-first, lightweight note service, easily capture and share your wonderful ideas, [flomo](https://flomoapp.com/) open source alternative |
| [fantasticit/think](https://github.com/fantasticit/think) | MIT | 1759 | 2022-02-20 | 2023-09-07 | An open source knowledge management tool, through an independent knowledge base space, structurally organize online collaborative documents, realize the accumulation and precipitation of knowledge, and promote the reuse and circulation of knowledge |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [fatedier/frp](https://github.com/fatedier/frp) | Apache-2.0 | 76144 | 2015-12-21 | 2024-01-16 | A high-performance reverse proxy application focused on intranet penetration, supporting multiple protocols such as TCP, UDP, HTTP, and HTTPS. Can expose intranet services to the public network through nodes with public IP in a safe and convenient way |
...
| [dromara/neutrino-proxy](https://github.com/dromara/neutrino-proxy) | MIT | 371 | 2022-06-10 | 2024-01-20 | An open source Java intranet penetration project based on Netty. |
| [ehang-io/nps](https://github.com/ehang-io/nps) | GPL-3.0 | 28228 | 2018-11-04 | 2024-01-11 | a lightweight, high-performance, powerful intranet penetration proxy server, with a powerful web management terminal. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [link1st/go-stress-testing](https://github.com/link1st/go-stress-testing) | NOASSERTION | 3361 | 2019-08-15 | 2024-01-16 | Golang implementation of stress testing tools |
| [grafana/k6](https://github.com/grafana/k6) | AGPL-3.0 | 22486 | 2016-03-21 | 2024-01-20 | A modern load testing tool, using Go and JavaScript |
...
| [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) | AGPL-3.0 | 3970 | 2020-12-20 | 2024-01-18 | A simple and easy-to-use open source interactive audit system developed by Golang, supporting RDP, SSH, VNC, Telnet, Kubernetes protocol |
...
| [trzsz/trzsz-ssh](https://github.com/trzsz/trzsz-ssh) | MIT | 1070 | 2023-05-21 | 2024-01-20 | Support trzsz (trz / tsz) ssh client, support search and select server for batch login, support remember password |
...
| [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) | AGPL-3.0 | 13053 | 2016-12-31 | 2024-01-20 | A tool for scanning whether the code contains sensitive information such as passwords and keys, which can be integrated into your pipeline |
...
| [grafana/pyroscope](https://github.com/grafana/pyroscope) | AGPL-3.0 | 9011 | 2020-12-31 | 2024-01-19 | Continuous Profiling Platform! CPU, memory, latency, errors, and more. |
...
| [avwo/whistle](https://github.com/avwo/whistle) | MIT | 13417 | 2015-03-13 | 2024-01-14 | Cross-platform local capture debugging tool based on Node |
...
| [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) | MIT | 58231 | 2019-08-21 | 2024-01-19 | Open source API development ecosystem, very high face value |
| [Kong/insomnia](https://github.com/Kong/insomnia) | Apache-2.0 | 32165 | 2016-04-23 | 2024-01-20 | An open source cross-platform API client, suitable for GraphQL, REST, WebSockets, Server-Sent Events (SSE), gRPC and any other HTTP compatible protocol |
| [Postcatlab/postcat](https://github.com/Postcatlab/postcat) | Apache-2.0 | 4679 | 2021-11-24 | 2024-01-03 | An extensible API tool platform, support multi-platform |
...
| [alibaba/canal](https://github.com/alibaba/canal) | Apache-2.0 | 27278 | 2013-01-13 | 2024-01-17 | Alibaba MySQL binlog incremental subscription &amp; consumption component |
| [86dbs/dbsyncer](https://github.com/86dbs/dbsyncer) | Apache-2.0 | 179 | 2022-10-11 | 2024-01-20 | An open source data synchronization middleware that provides MySQL, Oracle, SqlServer, PostgreSQL, Elasticsearch (ES), Kafka, File, SQL and other synchronization scenarios. Support upload plug-in custom synchronization conversion business, provide monitoring of full and incremental data statistics chart, application performance early warning, etc. |
...
| [alibaba/ilogtail](https://github.com/alibaba/ilogtail) | Apache-2.0 | 1438 | 2021-11-08 | 2024-01-20 | Lightweight, high-performance, automatically configured telemetry data (logs, traces, metrics) collection tool |
| [vectordotdev/vector](https://github.com/vectordotdev/vector) | MPL-2.0 | 15304 | 2018-08-27 | 2024-01-20 | A high-performance, high-reliability, observable data pipeline, much more powerful than Logstash |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Cloudreve/Cloudreve](https://github.com/Cloudreve/Cloudreve) | GPL-3.0 | 20158 | 2018-02-04 | 2024-01-05 | Public cloud file system that supports multiple cloud storage drivers |
| [alist-org/alist](https://github.com/alist-org/alist) | AGPL-3.0 | 34410 | 2020-12-23 | 2024-01-20 | 🗂️ A file list/WebDAV program that supports multiple storages, powered by Gin and Solidjs. |
...
| [doocs/advanced-java](https://github.com/doocs/advanced-java) | CC-BY-SA-4.0 | 73088 | 2018-10-06 | 2024-01-11 | A complete introduction to Java engineers advanced knowledge of the Internet: covering high-concurrency, distributed, high-availability, microservices, massive data processing and other fields of knowledge |
...
| [xiaobaiTech/golangFamily](https://github.com/xiaobaiTech/golangFamily) | N/A | 4714 | 2021-01-06 | 2023-12-23 | A collection of super Golang interview questions &#43; Golang learning guides &#43; Golang knowledge map &#43; entry growth route |
| [lifei6671/interview-go](https://github.com/lifei6671/interview-go) | Apache-2.0 | 4615 | 2018-02-26 | 2023-10-16 | Golang common interview questions collection |
| [chaseSpace/k8s-tutorial-cn](https://github.com/chaseSpace/k8s-tutorial-cn) | NOASSERTION | 774 | 2023-10-26 | 2024-01-20 | Chinese k8s tutorial, suitable for beginners to read |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [GoogleContainerTools/kaniko](https://github.com/GoogleContainerTools/kaniko) | Apache-2.0 | 13431 | 2018-01-29 | 2024-01-18 | Build Container Images In Kubernetes |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [buger/goreplay](https://github.com/buger/goreplay) | NOASSERTION | 18064 | 2013-05-30 | 2023-12-03 | Capture and replay live HTTP traffic into a test environment in order to continuously test your system with real data |
...
| [apache/pulsar](https://github.com/apache/pulsar) | Apache-2.0 | 13498 | 2016-06-28 | 2024-01-20 | Pulsar is a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [xiaodingding/iotfast](https://github.com/xiaodingding/iotfast) | Apache-2.0 | 274 | 2022-06-19 | 2022-08-24 | Iotfast is a lightweight, high-performance, cross-language, cross-platform IoT platform |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) | N/A | 18760 | 2019-10-09 | 2023-07-21 | Free terminal tool, SSH, Telnet, TCP, Shell, serial, support multi-platform |
| [withfig/autocomplete](https://github.com/withfig/autocomplete) | MIT | 23726 | 2020-09-29 | 2024-01-19 | A very powerful terminal command parameter auto-completion tool |
| [aristocratos/btop](https://github.com/aristocratos/btop) | Apache-2.0 | 14732 | 2021-05-06 | 2024-01-19 | A monitor of resources displaying usage and stats for processor, memory, disks, network and processes |
...
| [cli/cli](https://github.com/cli/cli) | MIT | 34335 | 2019-10-03 | 2024-01-19 | GitHub&#39;s official command line interaction tool |
...
| [muesli/duf](https://github.com/muesli/duf) | NOASSERTION | 11940 | 2020-09-20 | 2023-11-16 | A better df alternative |
...
| [antonmedv/fx](https://github.com/antonmedv/fx) | MIT | 17959 | 2018-01-25 | 2023-11-10 | Terminal JSON viewer &amp; processor |
...
| [orf/gping](https://github.com/orf/gping) | MIT | 9855 | 2015-10-17 | 2024-01-17 | Command line tool that pings and graphs |
| [http-party/http-server](https://github.com/http-party/http-server) | MIT | 13123 | 2011-06-16 | 2023-11-23 | A simple, zero-config command-line static HTTP server |
...
| [typicode/json-server](https://github.com/typicode/json-server) | NOASSERTION | 70161 | 2013-11-27 | 2024-01-14 | Get a full fake REST API with zero coding in less than 30 seconds (seriously) |
| [johnkerl/miller](https://github.com/johnkerl/miller) | NOASSERTION | 8379 | 2015-05-03 | 2024-01-19 | Similar to awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON |
...
| [Eugeny/tabby](https://github.com/Eugeny/tabby) | MIT | 53316 | 2016-12-23 | 2024-01-13 | An open source cross-platform supported terminal program that can easily manage host connections |
...
| [chubin/wttr.in](https://github.com/chubin/wttr.in) | Apache-2.0 | 23046 | 2015-12-26 | 2024-01-05 | Execute curl wttr.in to display the weather forecast in the terminal |
| [mikefarah/yq](https://github.com/mikefarah/yq) | MIT | 10114 | 2015-09-26 | 2024-01-12 | A lightweight and portable command-line YAML processor |
...
| [utmapp/utm](https://github.com/utmapp/utm) | Apache-2.0 | 22939 | 2019-04-12 | 2024-01-14 | Virtual machine tool for iOS and MacOS |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [1Panel-dev/1Panel](https://github.com/1Panel-dev/1Panel) | GPL-3.0 | 14917 | 2022-07-19 | 2024-01-20 | Modern, open source Linux server operation and maintenance management panel |
...
| [data-observe/datav](https://github.com/data-observe/datav) | Apache-2.0 | 3466 | 2017-09-28 | 2024-01-18 | A modern data visualization platform, built in 2023, can perform deep visualization and interactive operations on Metrics, Traces and Logs data |
...
| [dromara/mayfly-go](https://github.com/dromara/mayfly-go) | Apache-2.0 | 1464 | 2021-04-16 | 2024-01-19 | Web version Linux (terminal, file script, process, scheduled task), database (MySQL, Postgres, Daming), Redis (single machine, sentinel, cluster), MongoDB unified management operation platform |
...
| [wuranxu/pity](https://github.com/wuranxu/pity) | Apache-2.0 | 551 | 2021-03-06 | 2024-01-20 | A tool focusing on API automation, developed using Python&#43;FastApi&#43;React |
| [chaitin/safeline](https://github.com/chaitin/safeline) | NOASSERTION | 7741 | 2023-04-12 | 2024-01-19 | A free WAF that is simple enough, easy to use, and powerful enough. Based on the industry-leading semantic engine detection technology, it is accessed as a reverse proxy to protect your website from hacker attacks |
| [ansible-semaphore/semaphore](https://github.com/ansible-semaphore/semaphore) | MIT | 8628 | 2014-08-23 | 2024-01-18 | Modern UI for Ansible |
| [openspug/spug](https://github.com/openspug/spug) | AGPL-3.0 | 9508 | 2018-01-31 | 2024-01-10 | Lightweight agentless automation operation and maintenance platform |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [ansible/ansible](https://github.com/ansible/ansible) | GPL-3.0 | 59943 | 2012-03-06 | 2024-01-20 | A very simple IT automation platform that makes your applications and systems easier to deploy and maintain, based on ssh, no client required |
| [puppetlabs/puppet](https://github.com/puppetlabs/puppet) | Apache-2.0 | 7195 | 2010-09-14 | 2024-01-20 | Server automation framework and application |
| [hashicorp/terraform](https://github.com/hashicorp/terraform) | NOASSERTION | 40112 | 2014-03-13 | 2024-01-20 | Terraform enables you to safely and predictably create, change, and improve infrastructure. |
