...
<p>🧐 Divided into 69 categories. 📥 Includes 399 entries.</p>
...
| [gobackup/gobackup](https://github.com/gobackup/gobackup) | MIT|1222|2017-09-06|2024-01-22 | A backup tool designed for application servers to regularly back up your databases and files to cloud storage |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [dromara/Jpom](https://github.com/dromara/Jpom) | MIT|1086|2019-01-04|2024-01-18 | Simple and light low-intrusion online build, automatic deployment, daily operation and maintenance, project monitoring software |
| [argoproj/argo-cd](https://github.com/argoproj/argo-cd) | Apache-2.0|15213|2018-02-09|2024-01-24 | Declarative Continuous Deployment for Kubernetes |
| [dagger/dagger](https://github.com/dagger/dagger) | Apache-2.0|9492|2019-11-20|2024-01-24 | Application Delivery as Code that Runs Anywhere |
...
| [kbst/terraform-kubestack](https://github.com/kbst/terraform-kubestack) | Apache-2.0|603|2018-12-15|2024-01-24 | Kubestack is a framework for Kubernetes platform engineering teams to define the entire cloud native stack in one Terraform code base and continuously evolve the platform safely through GitOps. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [TencentBlueKing/bk-cmdb](https://github.com/TencentBlueKing/bk-cmdb) | NOASSERTION|5239|2016-12-12|2024-01-23 | Tencent BlueKing Configuration Platform is an enterprise-level configuration management platform for assets and applications |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [starsliao/TenSunS](https://github.com/starsliao/TenSunS) | WTFPL|1002|2022-01-28|2024-01-11 | Consul management, cloud resource monitoring management, site and interface monitoring management |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [jhuckaby/Cronicle](https://github.com/jhuckaby/Cronicle) | NOASSERTION|3027|2016-01-08|2024-01-05 | A simple, distributed task scheduler and runner with a web based UI. |
| [ouqiang/gocron](https://github.com/ouqiang/gocron) | MIT|5451|2017-02-20|2023-12-13 | A Golang light weight job scheduling system |
| [holdno/gopherCron](https://github.com/holdno/gopherCron) | N/A|385|2018-12-29|2024-01-23 | A distributed cron system written in Go |
| [whyour/qinglong](https://github.com/whyour/qinglong) | Apache-2.0|13302|2021-03-13|2024-01-22 | Timed task management platform supporting Python3, JavaScript, Shell, Typescript |
...
| [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) | MIT|8007|2020-08-26|2024-01-24 | Automatically get your public IP address and resolve it to the corresponding domain name service, support Aliyun, Tencent Cloud, DNSpod, Cloudflare, Huawei Cloud, Callback, Baidu Cloud, Porkbun, GoDaddy, Google, Domain, Namecheap, NameSilo |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Snapchat/KeyDB](https://github.com/Snapchat/KeyDB) | BSD-3-Clause|8573|2019-02-01|2024-01-10 | KeyDB is a high performance fork of Redis with a focus on multithreading, memory efficiency, and high throughput. In addition to performance improvements, KeyDB offers features such as Active Replication, FLASH Storage and Subkey Expires. |
| [Tencent/Tendis](https://github.com/Tencent/Tendis) | NOASSERTION|2742|2020-12-16|2023-04-27 | Tendis is a high-performance distributed storage system fully compatible with the Redis protocol. |
...
| [dragonflydb/dragonfly](https://github.com/dragonflydb/dragonfly) | NOASSERTION|22141|2021-12-11|2024-01-23 | Dragonfly is an in-memory database built for modern applications load demands, fully compatible with Redis and Memcached APIs, and no code changes are required when migrating. Compared to these traditional in-memory databases, Dragonfly offers 25 times the throughput, high cache hit rates and low tail latency, and can reduce resources for the same size workload by up to 80%. |
| [apache/kvrocks](https://github.com/apache/kvrocks) | Apache-2.0|2746|2019-08-15|2024-01-24 | A distributed key-value NoSQL database, using RocksDB as the storage engine, compatible with the Redis protocol. |
| [vesoft-inc/nebula](https://github.com/vesoft-inc/nebula) | Apache-2.0|9837|2018-08-28|2024-01-23 | A high-performance distributed graph database |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [cosmtrek/air](https://github.com/cosmtrek/air) | GPL-3.0|13657|2017-10-12|2024-01-23 | ☁️ A hot-reloading CLI tool designed for Go applications development |
| [curlconverter/curlconverter](https://github.com/curlconverter/curlconverter) | MIT|6909|2014-12-25|2024-01-05 | A tool that can convert curl commands into requests in various languages |
| [golangci/golangci-lint](https://github.com/golangci/golangci-lint) | GPL-3.0|13914|2018-05-04|2024-01-22 | Fast linters runner for Go. 5x faster than gometalinter. Nice colored output. Can report only new issues. Fewer false-positives. Yaml/toml config. Highly customizable. Many linters. Fewer mistakes. CI-integrated. Used by Uber, The New York Times, GitLab, HashiCorp, OpenShift and others. |
| [AykutSarac/jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com) | GPL-3.0|27121|2022-01-30|2024-01-23 | A tool that converts various data formats such as JSON, YAML, XML, CSV, etc. into interactive charts |
| [massCodeIO/massCode](https://github.com/massCodeIO/massCode) | AGPL-3.0|5275|2022-03-29|2024-01-20 | An open source local code snippet management tool |
| [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) | BSD-3-Clause|44346|2018-06-25|2024-01-19 | A simple zero-config tool to make locally trusted development certificates with any names you d like |
| [pre-commit/pre-commit-hooks](https://github.com/pre-commit/pre-commit-hooks) | MIT|4624|2014-03-13|2024-01-08 | Some out-of-the-box pre-check tools for code pre-commit |
...
| [ritz078/transform](https://github.com/ritz078/transform) | MIT|6667|2017-06-15|2023-12-27 | Multi-format file conversion tool, such as JSON to struct, etc. |
...
| [moby/buildkit](https://github.com/moby/buildkit) | Apache-2.0|7417|2017-05-31|2024-01-24 | Enhance the function of Docker build, support parallel build, cache, image export and other functions |
| [abiosoft/colima](https://github.com/abiosoft/colima) | MIT|15477|2021-09-04|2024-01-04 | Container runtime for MacOS and Linux, with minimal setup |
| [bcicen/ctop](https://github.com/bcicen/ctop) | MIT|14945|2016-12-27|2023-10-18 |  A command line tool for container metrics  |
| [wagoodman/dive](https://github.com/wagoodman/dive) | MIT|41981|2018-05-13|2024-01-20 | A tool for exploring a docker image, layer contents, and discovering ways to shrink the size of your Docker/OCI image |
...
| [louislam/dockge](https://github.com/louislam/dockge) | MIT|6574|2023-10-23|2024-01-24 | A fancy, easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager |
| [amir20/dozzle](https://github.com/amir20/dozzle) | MIT|3683|2018-10-30|2024-01-23 | Dozzle is a small lightweight application with a web based interface to monitor Docker logs. It doesn’t store any log files. It is for live monitoring of your container logs only. |
| [goharbor/harbor](https://github.com/goharbor/harbor) | Apache-2.0|21610|2016-01-28|2024-01-23 | The most well-known and probably the most widely used Docker image repository within the enterprise |
| [jesseduffield/lazydocker](https://github.com/jesseduffield/lazydocker) | MIT|32099|2019-05-18|2024-01-23 | A simple terminal UI for both docker and docker-compose, written in Go with the gocui library. |
| [portainer/portainer](https://github.com/portainer/portainer) | Zlib|27826|2016-05-19|2024-01-24 | Making Docker and Kubernetes management easy. |
...
| [slimtoolkit/slim](https://github.com/slimtoolkit/slim) | Apache-2.0|17733|2015-09-09|2024-01-24 | Do not change anything in your Docker container image and shrink it by up to 30x (for compiled languages even more) making it secure too! |
| [krallin/tini](https://github.com/krallin/tini) | MIT|9242|2015-02-27|2023-02-08 | A tiny but valid init for containers, PID 1, or init for short, is the first process launched in a new Unix session. It typically executes the init system, which is responsible for starting and managing services. |
...
| [elasticsearch-dump/elasticsearch-dump](https://github.com/elasticsearch-dump/elasticsearch-dump) | Apache-2.0|7196|2013-12-19|2023-12-08 | Index data import and export tool for Elasticsearch and OpenSearch |
...
| [zhuchunshu/SForum](https://github.com/zhuchunshu/SForum) | MIT|185|2021-07-08|2024-01-10 | ✨ A feature-rich, low-memory, componentized, high-performance forum program |
...
| [rocboss/paopao-ce](https://github.com/rocboss/paopao-ce) | MIT|3562|2022-05-24|2024-01-22 | A fresh and artistic micro-community, Gin&#43;Zinc&#43;Vue&#43;TS development |
...
| [Studio3T/robomongo](https://github.com/Studio3T/robomongo) | GPL-3.0|9237|2012-11-07|2022-09-22 | Native cross-platform MongoDB management tool |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [qishibo/AnotherRedisDesktopManager](https://github.com/qishibo/AnotherRedisDesktopManager) | MIT|28157|2019-01-08|2023-12-15 | 🚀 Faster, better and more stable redis desktop (GUI) client.  |
...
| [tiny-craft/tiny-rdm](https://github.com/tiny-craft/tiny-rdm) | GPL-3.0|3103|2023-06-27|2024-01-23 | A modern lightweight cross-platform Redis desktop manager, suitable for Mac, Windows and Linux. High face value, rich in functions. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) | NOASSERTION|6226|2020-06-11|2024-01-16 | MySQL/MariaDB database management for macOS |
...
| [beekeeper-studio/beekeeper-studio](https://github.com/beekeeper-studio/beekeeper-studio) | GPL-3.0|14412|2019-07-23|2024-01-23 | Modern and easy to use SQL client for MySQL, Postgres, SQLite, SQL Server, and more. Written with Electron &amp; Vue.js |
| [sqlitebrowser/sqlitebrowser](https://github.com/sqlitebrowser/sqlitebrowser) | NOASSERTION|19500|2014-05-04|2024-01-20 | A high quality, visual, open source tool to create, design, and edit database files compatible with SQLite. |
...
| [apache/apisix](https://github.com/apache/apisix) | Apache-2.0|13280|2019-04-10|2024-01-24 | A cloud-native microservices API gateway, delivering the ultimate performance, security, open source and scalable platform for all your APIs and microservices. |
...
| [alibaba/higress](https://github.com/alibaba/higress) | Apache-2.0|2060|2022-10-27|2024-01-23 | Higress implements three-layer gateways, including security protection gateway, traffic gateway and microservice gateway, which can significantly reduce the deployment and operation and maintenance costs of gateways. |
| [Kong/kong](https://github.com/Kong/kong) | Apache-2.0|36741|2014-11-17|2024-01-24 | A cloud-native, platform-agnostic, scalable API Gateway distinguished for its high performance and extensibility via plugins. |
| [apache/shenyu](https://github.com/apache/shenyu) | Apache-2.0|8195|2018-07-11|2024-01-24 | An asynchronous, high-performance, cross-language, responsive API gateway |
| [alibaba/tengine](https://github.com/alibaba/tengine) | BSD-2-Clause|12446|2012-03-21|2023-12-18 | A distribution of Nginx with some advanced features |
...
| [go-gitea/gitea](https://github.com/go-gitea/gitea) | MIT|40268|2016-11-01|2024-01-24 | Includes git repository hosting, code review, issue tracking, team collaboration, and CI/CD. Powerful, worth a try. Fork from Gogs |
| [gogs/gogs](https://github.com/gogs/gogs) | MIT|43669|2014-02-12|2024-01-01 | The simplest, fastest and easiest way to build a self-service Git service, developed on Golang and supporting multiple platforms. |
| [theonedev/onedev](https://github.com/theonedev/onedev) | MIT|12205|2018-11-06|2024-01-24 | A completely free and open source Git code hosting service that supports one-line command installation to your own server |
...
| [yunionio/cloudpods](https://github.com/yunionio/cloudpods) | Apache-2.0|2199|2018-07-27|2024-01-24 | Open source, cloud-native multi-cloud and hybrid cloud fusion platform |
...
| [derailed/k9s](https://github.com/derailed/k9s) | Apache-2.0|23639|2019-01-25|2024-01-22 | Kubernetes CLI To Manage Your Clusters In Style! |
| [karmada-io/karmada](https://github.com/karmada-io/karmada) | Apache-2.0|3855|2020-11-10|2024-01-24 | Karmada aims to provide unified packaging automation for multi-cluster application management in multi-cloud and hybrid cloud scenarios, with key functions such as centralized multi-cloud management, high availability, fault recovery and traffic scheduling. |
| [openkruise/kruise](https://github.com/openkruise/kruise) | NOASSERTION|4249|2019-05-30|2024-01-24 | Automated management of large-scale applications on Kubernetes (incubating project under CNCF) |
...
| [eip-work/kuboard-press](https://github.com/eip-work/kuboard-press) | N/A|20414|2019-07-24|2024-01-10 | K8s multi-cluster management platform, the open source free version only supports up to 3 clusters |
| [redkubes/otomi-core](https://github.com/redkubes/otomi-core) | Apache-2.0|2075|2019-08-01|2024-01-23 | Self-hosted DevOps Platform for Kubernetes |
| [goodrain/rainbond](https://github.com/goodrain/rainbond) | LGPL-3.0|4572|2017-11-05|2024-01-22 | k8s cluster management application platform |
| [rancher/rancher](https://github.com/rancher/rancher) | Apache-2.0|22045|2014-11-07|2024-01-24 | Rancher is an open source container management platform built for organizations that deploy containers in production. Rancher makes it easy to run Kubernetes everywhere, meet IT requirements, and empower DevOps teams. |
...
| [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) | Apache-2.0|10242|2021-04-19|2024-01-23 | API traffic analyzer for K8s, providing real-time protocol-level visibility into your K8s internal network, capturing and monitoring all traffic and load across containers, pods, nodes and clusters |
| [traefik/traefik](https://github.com/traefik/traefik) | MIT|46370|2015-09-13|2024-01-24 | A modern HTTP reverse proxy and load balancer that makes it easy to deploy microservices |
...
| [cert-manager/cert-manager](https://github.com/cert-manager/cert-manager) | Apache-2.0|11077|2017-05-24|2024-01-22 | Automatically provision and manage TLS certificates in Kubernetes |
...
| [kedacore/keda](https://github.com/kedacore/keda) | Apache-2.0|7433|2019-02-13|2024-01-23 | KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes |
...
| [kubernetes/kompose](https://github.com/kubernetes/kompose) | Apache-2.0|8938|2016-06-27|2024-01-23 | Convert Docker Compose to Kubernetes |
| [kubernetes/kops](https://github.com/kubernetes/kops) | Apache-2.0|15396|2016-06-27|2024-01-24 | Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management |
| [kubernetes-sigs/krew](https://github.com/kubernetes-sigs/krew) | Apache-2.0|5990|2018-07-12|2024-01-10 | Find and install kubectl plugins |
...
| [aquasecurity/kube-bench](https://github.com/aquasecurity/kube-bench) | Apache-2.0|6451|2017-06-19|2024-01-23 | Checks whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark |
...
| [prometheus-operator/kube-prometheus](https://github.com/prometheus-operator/kube-prometheus) | Apache-2.0|6011|2016-10-24|2024-01-22 | Use Prometheus to monitor Kubernetes and applications running on Kubernetes |
...
| [ahmetb/kubectx](https://github.com/ahmetb/kubectx) | Apache-2.0|16449|2017-03-30|2024-01-21 | Faster way to switch between clusters and namespaces in kubectl |
...
| [robusta-dev/kubewatch](https://github.com/robusta-dev/kubewatch) | Apache-2.0|445|2021-03-19|2023-12-28 | Watch k8s events and trigger Handlers |
| [kubeshop/monokle](https://github.com/kubeshop/monokle) | MIT|1445|2021-06-04|2024-01-11 | Better create, understand and deploy YAML manifests with a visual UI that also offers policy validation and cluster insights |
...
| [bitnami-labs/sealed-secrets](https://github.com/bitnami-labs/sealed-secrets) | Apache-2.0|6862|2017-05-29|2024-01-23 | A Kubernetes controller and tool for one-way encrypted Secrets |
| [labring/sealos](https://github.com/labring/sealos) | Apache-2.0|12381|2018-08-15|2024-01-23 | A Cloud Operating System designed for managing cloud-native applications |
| [GoogleContainerTools/skaffold](https://github.com/GoogleContainerTools/skaffold) | Apache-2.0|14455|2018-01-23|2024-01-23 | Easy and Repeatable Kubernetes Development |
...
| [telepresenceio/telepresence](https://github.com/telepresenceio/telepresence) | NOASSERTION|6199|2017-02-23|2024-01-23 | Local development against a remote Kubernetes or OpenShift cluster |
...
| [provectus/kafka-ui](https://github.com/provectus/kafka-ui) | Apache-2.0|7800|2019-11-26|2024-01-20 | A Kafka-Web management background written in Python&#43;Vue |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | Apache-2.0|10233|2018-09-30|2024-01-24 | Fast, economical and efficient monitoring solution and time series database, which can be used for storage of Prometheus or Grafana |
...
| [dataease/dataease](https://github.com/dataease/dataease) | GPL-3.0|14271|2021-02-02|2024-01-24 | DataEase is an open source data visualization analysis tool that helps users quickly analyze data and gain insight into business trends, thereby improving and optimizing business. DataEase supports a wealth of data source connections, can quickly create charts through drag and drop, and can easily share with others. |
...
| [grafana/grafana](https://github.com/grafana/grafana) | AGPL-3.0|58947|2013-12-11|2024-01-24 | The open and composable observability and data visualization platform. Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, Elasticsearch, InfluxDB, Postgres and many more. |
| [dromara/hertzbeat](https://github.com/dromara/hertzbeat) | Apache-2.0|4025|2022-02-04|2024-01-22 | Easy-to-use and friendly open source real-time monitoring and alarm system, no need for Agent, high-performance cluster, compatible with Prometheus, powerful custom monitoring capabilities |
| [hyperdxio/hyperdx](https://github.com/hyperdxio/hyperdx) | MIT|5513|2023-09-13|2024-01-24 | An open source observability platform unifying session replays, logs, metrics, traces and errors. |
...
| [grafana/loki](https://github.com/grafana/loki) | AGPL-3.0|21086|2018-04-16|2024-01-24 | Horizontally scalable, highly available, multi-tenant log aggregation system. Its design is very economical and efficient and easy to operate. It does not index the content of the log, but establishes a set of tags for each log stream. |
| [ccfos/nightingale](https://github.com/ccfos/nightingale) | Apache-2.0|8300|2020-03-03|2024-01-23 | All-in-One cloud native monitoring tool, which combines the advantages of Prometheus and Grafana. You can manage and configure alarm strategies on the WebUI, and you can also visualize and analyze metrics, logs, and link tracking data distributed in multiple regions |
| [SigNoz/signoz](https://github.com/SigNoz/signoz) | NOASSERTION|16030|2021-01-03|2024-01-23 | SigNoz is an open-source observability platform native to OpenTelemetry with logs, traces and metrics in a single application. An open-source alternative to DataDog, NewRelic, etc. Open source Application Performance Monitoring (APM) &amp; Observability tool |
| [starsliao/TenSunS](https://github.com/starsliao/TenSunS) | WTFPL|1002|2022-01-28|2024-01-11 | Consul-based Operations Platform: A More Elegant Consul Management UI &amp; Syncing Prometheus/JumpServer Metrics for Multi-cloud and Self-hosted ECS/MySQL/Redis &amp; Cloud Monitoring for ECS/MySQL/Redis &amp; Blackbox Site Monitoring Maintenance &amp; Vulnerability Notifications/Resource Expiry Balance Alerts &amp; Various Resource Dashboards Displayed in Grafana |
| [mikecao/umami](https://github.com/mikecao/umami) | MIT|18321|2020-07-17|2024-01-19 | Easy to build and configure, elegant and beautiful site access statistics tool |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [LeslieLeung/heimdallr](https://github.com/LeslieLeung/heimdallr) | GPL-3.0|172|2022-05-27|2024-01-24 | A very lightweight notification gateway that can aggregate various push channels, deploy with Serverless, and run at almost zero cost. |
| [songquanpeng/message-pusher](https://github.com/songquanpeng/message-pusher) | MIT|1657|2020-09-01|2023-12-19 | Build your own custom messaging service that supports multiple messaging channels, Markdown, and is a single executable file that is ready to use out of the box. |
| [novuhq/novu](https://github.com/novuhq/novu) | MIT|31631|2021-08-26|2024-01-23 | The ultimate service for managing multi-channel notifications with a single API. |
...
| [logto-io/logto](https://github.com/logto-io/logto) | MPL-2.0|6767|2021-06-19|2024-01-24 | An Auth0 alternative designed for modern applications and SaaS products. It provides a seamless developer experience and is great for individuals and growing companies |
| [zitadel/zitadel](https://github.com/zitadel/zitadel) | Apache-2.0|6048|2020-03-16|2024-01-23 | Enterprise-level unified identity authentication management system |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) | AGPL-3.0|1353|2021-02-19|2024-01-20 | a comprehensive web-based interface designed to simplify the management and configuration of Nginx servers. |
...
| [cnpm/cnpmcore](https://github.com/cnpm/cnpmcore) | MIT|510|2021-08-05|2024-01-23 | Front end npm package manager |
| [composer/composer](https://github.com/composer/composer) | MIT|28039|2011-06-08|2024-01-22 | Private server program for PHP language stack |
| [dzikoysk/reposilite](https://github.com/dzikoysk/reposilite) | Apache-2.0|1152|2017-07-06|2024-01-20 | Lightweight and easy to use repository manager for JVM ecosystem based on Maven |
...
| [prometheus/node_exporter](https://github.com/prometheus/node_exporter) | Apache-2.0|9833|2013-04-18|2024-01-22 | Exporter for machine metrics |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [tair-opensource/RedisShake](https://github.com/tair-opensource/RedisShake) | MIT|3508|2019-02-28|2024-01-19 | RedisShake is a Redis data processing and migration tool. |
| [sohutv/cachecloud](https://github.com/sohutv/cachecloud) | Apache-2.0|8236|2016-01-26|2023-12-25 | Support Redis multi-architecture (Standalone, Sentinel, Cluster) efficient management, effectively reduce the large-scale redis operation and maintenance costs, improve resource management capabilities and utilization. The platform provides fast build/migration, operation and maintenance management, elastic scaling, statistical monitoring, client integration access and other functions |
...
| [Bytebase/Bytebase](https://github.com/Bytebase/Bytebase) | NOASSERTION|9232|2021-01-27|2024-01-24 | The world most advanced database DevOps and CI/CD for developers, DBAs and platform engineering teams |
| [cookieY/Yearning](https://github.com/cookieY/Yearning) | AGPL-3.0|8113|2017-10-18|2024-01-15 | Simple and efficient MySQL audit platform |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) | MIT|41353|2018-04-23|2024-01-23 | ⚡ Lightning Fast, Ultra Relevant, and Typo-Tolerant Search Engine written in Rust 🔍 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | AGPL-3.0|7979|2023-02-02|2024-01-24 | A cloud-native observability platform, built for logs, metrics, traces, analytics, and RUM (Real User Monitoring - performance, errors, session replay), designed for PB scale workloads |
| [zincsearch/zincsearch](https://github.com/zincsearch/zincsearch) | NOASSERTION|15988|2021-12-02|2024-01-14 | A search engine for full-text indexing. It is a lightweight alternative to Elasticsearch and uses only a small fraction of resources at runtime. It uses blue as the underlying index library |
...
| [oldratlee/useful-scripts](https://github.com/oldratlee/useful-scripts) | Apache-2.0|7074|2013-03-12|2024-01-14 | 👉 Useful manual operations are made into scripts for easy use, making daily life of development easier |
...
| [localsend/localsend](https://github.com/localsend/localsend) | MIT|27131|2022-12-16|2024-01-23 | A free, open-source application that allows you to securely share files and messages with nearby devices on your local network without an internet connection |
| [lra/mackup](https://github.com/lra/mackup) | GPL-3.0|13934|2013-04-06|2024-01-19 | A tool that keeps your application configuration in sync |
| [mtlynch/picoshare](https://github.com/mtlynch/picoshare) | NOASSERTION|1976|2022-02-14|2024-01-16 | A file sharing service that supports multiple types, easy to deploy and easy to use |
| [syncthing/syncthing](https://github.com/syncthing/syncthing) | MPL-2.0|57650|2013-11-26|2024-01-24 | Open source cross-platform file synchronization tool |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [bjdgyc/anylink](https://github.com/bjdgyc/anylink) | AGPL-3.0|1240|2020-08-18|2024-01-24 | An enterprise remote office SSL VPN software that can support multiple people to use online at the same time |
...
| [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) | MIT|32926|2014-09-20|2024-01-18 | For managing and switching multiple Node versions in Windows system |
| [nvm-sh/nvm](https://github.com/nvm-sh/nvm) | MIT|73254|2010-04-15|2024-01-20 | A simple tool for managing and switching multiple Node versions |
...
| [version-fox/vfox](https://github.com/version-fox/vfox) | Apache-2.0|85|2023-12-09|2024-01-24 | A cross-platform tool for managing SDK versions, allowing you to quickly install and switch different versions of SDK through the command line |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [BookStackApp/BookStack](https://github.com/BookStackApp/BookStack) | MIT|13173|2015-08-29|2024-01-23 | A platform to create documentation/wiki content built with PHP &amp; Laravel |
| [zmister2016/MrDoc](https://github.com/zmister2016/MrDoc) | GPL-3.0|2722|2020-04-10|2024-01-23 | online document system developed based on python. It is suitable for individuals and small teams to manage documents, wiki, knowledge and notes.  |
| [facebook/docusaurus](https://github.com/facebook/docusaurus) | MIT|50899|2017-06-20|2024-01-23 | A project for easily building, deploying, and maintaining open source project websites |
| [halo-dev/halo](https://github.com/halo-dev/halo) | GPL-3.0|30335|2018-03-21|2024-01-24 | Powerful and easy-to-use open source website building tools, more biased towards blog style |
| [usememos/memos](https://github.com/usememos/memos) | MIT|22496|2021-12-08|2024-01-24 | A privacy-first, lightweight note service, easily capture and share your wonderful ideas, [flomo](https://flomoapp.com/) open source alternative |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [fatedier/frp](https://github.com/fatedier/frp) | Apache-2.0|76311|2015-12-21|2024-01-21 | A high-performance reverse proxy application focused on intranet penetration, supporting multiple protocols such as TCP, UDP, HTTP, and HTTPS. Can expose intranet services to the public network through nodes with public IP in a safe and convenient way |
...
| [dromara/neutrino-proxy](https://github.com/dromara/neutrino-proxy) | MIT|374|2022-06-10|2024-01-22 | An open source Java intranet penetration project based on Netty. |
| [ehang-io/nps](https://github.com/ehang-io/nps) | GPL-3.0|28266|2018-11-04|2024-01-11 | a lightweight, high-performance, powerful intranet penetration proxy server, with a powerful web management terminal. |
...
| [grafana/k6](https://github.com/grafana/k6) | AGPL-3.0|22502|2016-03-21|2024-01-22 | A modern load testing tool, using Go and JavaScript |
...
| [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) | AGPL-3.0|3983|2020-12-20|2024-01-18 | A simple and easy-to-use open source interactive audit system developed by Golang, supporting RDP, SSH, VNC, Telnet, Kubernetes protocol |
...
| [trzsz/trzsz-ssh](https://github.com/trzsz/trzsz-ssh) | MIT|1118|2023-05-21|2024-01-21 | Support trzsz (trz / tsz) ssh client, support search and select server for batch login, support remember password |
...
| [reviewdog/reviewdog](https://github.com/reviewdog/reviewdog) | MIT|7008|2016-10-17|2024-01-23 | reviewdog provides a way to post review comments to code hosting service, such as GitHub, automatically by integrating with any linter tools with ease. It uses an output of lint tools and posts them as a comment if findings are in diff of patches to review. |
| [SonarSource/sonarqube](https://github.com/SonarSource/sonarqube) | LGPL-3.0|8333|2011-01-05|2024-01-24 | SonarQube not only shows the health of an application but also highlights newly introduced issues. With a Quality Gate in place, you can fix the leak and therefore improve code quality systematically. |
| [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) | AGPL-3.0|13081|2016-12-31|2024-01-24 | A tool for scanning whether the code contains sensitive information such as passwords and keys, which can be integrated into your pipeline |
...
| [wansenai/flow](https://github.com/wansenai/flow) | Apache-2.0|664|2021-05-27|2023-12-27 | Out-of-the-box process engine integrated solution |
...
| [grafana/pyroscope](https://github.com/grafana/pyroscope) | AGPL-3.0|9029|2020-12-31|2024-01-23 | Continuous Profiling Platform! CPU, memory, latency, errors, and more. |
...
| [avwo/whistle](https://github.com/avwo/whistle) | MIT|13421|2015-03-13|2024-01-14 | Cross-platform local capture debugging tool based on Node |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [apicat/apicat](https://github.com/apicat/apicat) | MIT|233|2022-05-05|2024-01-24 | An API development tool based on AI technology, which aims to help developers develop APIs faster and more efficiently through automation and intelligence |
| [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) | MIT|58290|2019-08-21|2024-01-23 | Open source API development ecosystem, very high face value |
| [Kong/insomnia](https://github.com/Kong/insomnia) | Apache-2.0|32205|2016-04-23|2024-01-23 | An open source cross-platform API client, suitable for GraphQL, REST, WebSockets, Server-Sent Events (SSE), gRPC and any other HTTP compatible protocol |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [brokercap/Bifrost](https://github.com/brokercap/Bifrost) | Apache-2.0|1768|2018-04-12|2023-12-31 | MySQL,MariaDB,kafka synchronization to Redis,MongoDB,ClickHouse,StarRocks,Doris,Kafka and other services |
| [alibaba/canal](https://github.com/alibaba/canal) | Apache-2.0|27294|2013-01-13|2024-01-17 | Alibaba MySQL binlog incremental subscription &amp; consumption component |
...
| [vectordotdev/vector](https://github.com/vectordotdev/vector) | MPL-2.0|15330|2018-08-27|2024-01-24 | A high-performance, high-reliability, observable data pipeline, much more powerful than Logstash |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [Cloudreve/Cloudreve](https://github.com/Cloudreve/Cloudreve) | GPL-3.0|20189|2018-02-04|2024-01-05 | Public cloud file system that supports multiple cloud storage drivers |
| [alist-org/alist](https://github.com/alist-org/alist) | AGPL-3.0|34499|2020-12-23|2024-01-23 | 🗂️ A file list/WebDAV program that supports multiple storages, powered by Gin and Solidjs. |
...
| [tl-open-source/tl-rtc-file](https://github.com/tl-open-source/tl-rtc-file) | MIT|2026|2021-08-05|2024-01-10 | Media stream transmission tool based on WebRTC |
...
| [doocs/advanced-java](https://github.com/doocs/advanced-java) | CC-BY-SA-4.0|73125|2018-10-06|2024-01-11 | A complete introduction to Java engineers advanced knowledge of the Internet: covering high-concurrency, distributed, high-availability, microservices, massive data processing and other fields of knowledge |
...
| [jaywcjlove/reference](https://github.com/jaywcjlove/reference) | MIT|8516|2022-09-24|2024-01-23 | Quick reference checklist for developers to share |
| [TeamStuQ/skill-map](https://github.com/TeamStuQ/skill-map) | N/A|19637|2015-11-17|2023-01-20 | Programmer skill map |
| [isno/theByteBook](https://github.com/isno/theByteBook) | N/A|5468|2022-10-08|2024-01-22 | In-depth explanation of kernel network, Kubernetes, ServiceMesh, containers and other cloud native related technologies, DevOps, SRE guide verified by practice |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [GoogleContainerTools/kaniko](https://github.com/GoogleContainerTools/kaniko) | Apache-2.0|13451|2018-01-29|2024-01-23 | Build Container Images In Kubernetes |
| [hashicorp/packer](https://github.com/hashicorp/packer) | NOASSERTION|14765|2013-03-23|2024-01-24 | A tool that supports building machine images based on configuration files |
...
| [apache/pulsar](https://github.com/apache/pulsar) | Apache-2.0|13507|2016-06-28|2024-01-24 | Pulsar is a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [chaosblade-io/chaosblade](https://github.com/chaosblade-io/chaosblade) | Apache-2.0|5670|2019-03-12|2024-01-12 | An experiment injection tool that follows the chaos engineering principle and chaos experiment model, helps enterprises improve the fault tolerance of distributed systems, and ensures business continuity during the enterprise cloud or migration to cloud native systems |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) | N/A|18836|2019-10-09|2024-01-23 | Free terminal tool, SSH, Telnet, TCP, Shell, serial, support multi-platform |
| [withfig/autocomplete](https://github.com/withfig/autocomplete) | MIT|23743|2020-09-29|2024-01-22 | A very powerful terminal command parameter auto-completion tool |
| [aristocratos/btop](https://github.com/aristocratos/btop) | Apache-2.0|14777|2021-05-06|2024-01-23 | A monitor of resources displaying usage and stats for processor, memory, disks, network and processes |
...
| [cli/cli](https://github.com/cli/cli) | MIT|34362|2019-10-03|2024-01-23 | GitHub&#39;s official command line interaction tool |
...
| [muesli/duf](https://github.com/muesli/duf) | NOASSERTION|11952|2020-09-20|2023-11-16 | A better df alternative |
...
| [antonmedv/fx](https://github.com/antonmedv/fx) | MIT|17973|2018-01-25|2023-11-10 | Terminal JSON viewer &amp; processor |
...
| [typicode/json-server](https://github.com/typicode/json-server) | NOASSERTION|70210|2013-11-27|2024-01-22 | Get a full fake REST API with zero coding in less than 30 seconds (seriously) |
| [johnkerl/miller](https://github.com/johnkerl/miller) | NOASSERTION|8393|2015-05-03|2024-01-23 | Similar to awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON |
| [voidcosmos/npkill](https://github.com/voidcosmos/npkill) | MIT|7727|2019-06-30|2023-12-02 | This tool can list any node_modules directory in the system and the space they occupy. Then, you can choose which files to clear to free up space |
...
| [XiaoMi/soar](https://github.com/XiaoMi/soar) | Apache-2.0|8538|2018-10-08|2023-12-15 | SQL Optimising And Rewriting tool, support multiple databases |
| [Eugeny/tabby](https://github.com/Eugeny/tabby) | MIT|53402|2016-12-23|2024-01-23 | An open source cross-platform supported terminal program that can easily manage host connections |
...
| [chubin/wttr.in](https://github.com/chubin/wttr.in) | Apache-2.0|23064|2015-12-26|2024-01-05 | Execute curl wttr.in to display the weather forecast in the terminal |
| [mikefarah/yq](https://github.com/mikefarah/yq) | MIT|10129|2015-09-26|2024-01-12 | A lightweight and portable command-line YAML processor |
...
| [utmapp/utm](https://github.com/utmapp/utm) | Apache-2.0|22979|2019-04-12|2024-01-14 | Virtual machine tool for iOS and MacOS |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [1Panel-dev/1Panel](https://github.com/1Panel-dev/1Panel) | GPL-3.0|14987|2022-07-19|2024-01-23 | Modern, open source Linux server operation and maintenance management panel |
...
| [idcos/cloudiac](https://github.com/idcos/cloudiac) | Apache-2.0|107|2021-08-04|2024-01-24 | Cloud environment automation management platform based on infrastructure as code |
...
| [data-observe/datav](https://github.com/data-observe/datav) | Apache-2.0|3473|2017-09-28|2024-01-23 | A modern data visualization platform, built in 2023, can perform deep visualization and interactive operations on Metrics, Traces and Logs data |
...
| [mouday/domain-admin](https://github.com/mouday/domain-admin) | MIT|1172|2022-09-23|2024-01-24 | Domain and SSL certificate monitoring platform based on Python &#43; Vue3.js technology stack |
...
| [harness/gitness](https://github.com/harness/gitness) | Apache-2.0|31049|2014-02-07|2024-01-24 | Gitness is an Open Source developer platform with Source Control management, Continuous Integration and Continuous Delivery. |
| [dromara/mayfly-go](https://github.com/dromara/mayfly-go) | Apache-2.0|1480|2021-04-16|2024-01-23 | Web version Linux (terminal, file script, process, scheduled task), database (MySQL, Postgres, Daming), Redis (single machine, sentinel, cluster), MongoDB unified management operation platform |
...
| [wuranxu/pity](https://github.com/wuranxu/pity) | Apache-2.0|555|2021-03-06|2024-01-23 | A tool focusing on API automation, developed using Python&#43;FastApi&#43;React |
| [chaitin/safeline](https://github.com/chaitin/safeline) | NOASSERTION|7774|2023-04-12|2024-01-19 | A free WAF that is simple enough, easy to use, and powerful enough. Based on the industry-leading semantic engine detection technology, it is accessed as a reverse proxy to protect your website from hacker attacks |
| [ansible-semaphore/semaphore](https://github.com/ansible-semaphore/semaphore) | MIT|8644|2014-08-23|2024-01-20 | Modern UI for Ansible |
| [openspug/spug](https://github.com/openspug/spug) | AGPL-3.0|9517|2018-01-31|2024-01-10 | Lightweight agentless automation operation and maintenance platform |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [ansible/ansible](https://github.com/ansible/ansible) | GPL-3.0|59971|2012-03-06|2024-01-23 | A very simple IT automation platform that makes your applications and systems easier to deploy and maintain, based on ssh, no client required |
...
| [chef/chef](https://github.com/chef/chef) | Apache-2.0|7399|2009-01-15|2024-01-23 | Chef Infra, a powerful automation platform that transforms infrastructure into code automating how infrastructure is configured, deployed and managed across any environment, at any scale |
...
| [saltstack/salt](https://github.com/saltstack/salt) | Apache-2.0|13709|2011-02-20|2024-01-23 | Software to automate the management and configuration of any infrastructure or application at scale. |
...
| [hashicorp/terraform](https://github.com/hashicorp/terraform) | NOASSERTION|40142|2014-03-13|2024-01-24 | Terraform enables you to safely and predictably create, change, and improve infrastructure. |
...
| Repository  | License | Star  |CreatedAt | UpdatedAt  | Description |
|:-:|:-:|:-:|:-:|:-:|:-:|
| [apolloconfig/apollo](https://github.com/apolloconfig/apollo) | Apache-2.0|28603|2016-03-04|2024-01-23 | Apollo is a reliable configuration management system. It can centrally manage the configurations of different applications and different clusters. It is suitable for microservice configuration management scenarios. |
| [alibaba/nacos](https://github.com/alibaba/nacos) | Apache-2.0|28408|2018-06-15|2024-01-22 | an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications. |
